...
description: Test source page for tests/test_test_bundle.py.
---

# `tests/test_test_bundle.py`

- SHA-256: `27fd121c8a59200ffcafcfccaa6e01ca3c2bd488680f3209bbe95097686f7061`
- Size: `4231` bytes
- Test functions: `5`

```python
"""Verify the current toolkit behavior covered by `tests/test_test_bundle.py`."""
...
def test_static_test_bundle_inspection(tmp_path: Path) -> None:
    """Verify static test bundle inspection behavior."""
...
def test_test_bundle_hash_is_enforced(tmp_path: Path) -> None:
    """Verify test bundle hash is enforced behavior."""
...
def test_test_bundle_rejects_path_traversal(tmp_path: Path) -> None:
    """Verify test bundle rejects path traversal behavior."""
...
def test_test_bundle_requires_authorization(tmp_path: Path) -> None:
    """Verify test bundle requires authorization behavior."""
    target = build_minimal_pe32(tmp_path / "target.exe")
    manifest = {
        "schema_version": 1,
...
def test_create_test_bundle_round_trip(tmp_path: Path) -> None:
    """Verify create test bundle round trip behavior."""
