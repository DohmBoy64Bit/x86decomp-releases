...
description: Test source page for tests/assembly/test_pipeline_cli_schemas.py.
---

# `tests/assembly/test_pipeline_cli_schemas.py`

- SHA-256: `58c18cc8d7da6b1d2dac5b42383d20bc381e303a4c2be28b25e926118bb4db64`
- Size: `9264` bytes
- Test functions: `8`
...
def test_assembly_project_cli_and_all_leaf_help(tmp_path: Path, capsys) -> None:
    ...
    assert check["release_version"] == "0.7.11"
