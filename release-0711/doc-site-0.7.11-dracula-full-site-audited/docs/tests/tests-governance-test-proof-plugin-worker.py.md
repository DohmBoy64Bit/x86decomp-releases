...
description: Test source page for tests/governance/test_proof_plugin_worker.py.
---
...
```python
"""Verify the current toolkit behavior covered by `tests/governance/test_proof_plugin_worker.py`."""
...
def test_proof_ledger_and_bundle(tmp_path: Path) -> None:
    """Verify proof ledger and bundle behavior."""
...
def test_proof_bundle_rejects_outside_artifact(tmp_path: Path) -> None:
    """Verify proof bundle rejects outside artifact behavior."""
...
def test_plugin_install_doctor_invoke(tmp_path: Path) -> None:
    """Verify plugin install doctor invoke behavior."""
...
def test_plugin_rejects_undeclared_capability(tmp_path: Path) -> None:
    """Verify plugin rejects undeclared capability behavior."""
...
def test_worker_registry_selection_and_doctor(tmp_path: Path) -> None:
    """Verify worker registry selection and doctor behavior."""
...
def test_changeset_round_trip(tmp_path: Path) -> None:
    """Verify changeset round trip behavior."""
...
def test_changeset_base_mismatch(tmp_path: Path) -> None:
    """Verify changeset base mismatch behavior."""
...
def test_plugin_list_and_proof_inspect(tmp_path: Path) -> None:
    """Verify plugin list and proof inspect behavior."""
