...
description: Test source page for tests/test_pe32.py.
---

# `tests/test_pe32.py`

- SHA-256: `0566aa1335fa09514110eba2495853f1eb0a06529f033546153e22dbb9a7ba4e`
- Size: `1411` bytes
- Test functions: `2`

```python
"""Verify the current toolkit behavior covered by `tests/test_pe32.py`."""
