...
description: Test source page for tests/test_integration.py.
---
...
```python
"""Verify the current toolkit behavior covered by `tests/test_integration.py`."""
...
def test_integration_requires_explicit_host_consent(tmp_path: Path) -> None:
    """Verify integration requires explicit host consent behavior."""
...
def test_integration_equivalence_and_difference(tmp_path: Path) -> None:
    """Verify integration equivalence and difference behavior."""
