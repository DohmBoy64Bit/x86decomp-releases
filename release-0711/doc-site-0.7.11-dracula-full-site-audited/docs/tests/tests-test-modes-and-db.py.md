---
title: tests/test_modes_and_db.py
description: Test source page for tests/test_modes_and_db.py.
---
...
```python
"""Verify the current toolkit behavior covered by `tests/test_modes_and_db.py`."""
...
def test_independent_modes_and_monotonic_state(tmp_path: Path) -> None:
    """Verify independent modes and monotonic state behavior."""
    project = tmp_path / "p"
...
def test_type_constraint_conflict_gate(tmp_path: Path) -> None:
    """Verify type constraint conflict gate behavior."""
