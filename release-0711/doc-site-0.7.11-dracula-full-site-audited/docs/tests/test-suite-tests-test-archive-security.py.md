...
description: Test source page for test-suite/tests/test_archive_security.py.
---
...
```python
"""Provide test-suite.tests.test_archive_security functionality for the x86decomp-toolkit 0.7.11 release.
