...
description: Test source page for test-suite/src/x86decomp_testkit/self_tests/test_inventory_reports_process.py.
---

# `test-suite/src/x86decomp_testkit/self_tests/test_inventory_reports_process.py`

- SHA-256: `382524e4b814f813ea18b7ba1012522f9176997e4be92d3e59c59c0911784a11`
- Size: `6099` bytes
- Test functions: `4`
...
from x86decomp_testkit.logging_utils import configure_logging
from x86decomp_testkit.models import ProbeResult, RunSummary, Status
...
def test_inventory_catalog_and_public_coverage(tmp_path: Path) -> None:
    """Verify inventory catalog and public coverage behavior."""
...
def test_junit_process_logging_and_reports(tmp_path: Path) -> None:
    """Verify junit process logging and reports behavior."""
...
def test_suite_schemas_and_catalog_are_valid() -> None:
    """Verify suite schemas and catalog are valid behavior."""
...
def test_recursive_inventory_includes_capability_packages_and_nested_schemas(tmp_path: Path) -> None:
    """Verify recursive inventory includes capability packages and nested schemas behavior."""
    root = _mini_toolkit(tmp_path / "toolkit")
