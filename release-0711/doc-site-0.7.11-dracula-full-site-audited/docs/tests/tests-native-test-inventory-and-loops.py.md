...
description: Test source page for tests/native/test_inventory_and_loops.py.
---
...
```python
"""Verify the current toolkit behavior covered by `tests/native/test_inventory_and_loops.py`."""
...
def test_native_cli_json_helpers(tmp_path: Path) -> None:
    """Verify native cli json helpers behavior."""
...
def test_project_inventory_audit_pe_inventory_reports_and_doctor(tmp_path: Path) -> None:
    """Verify project inventory audit pe inventory reports and doctor behavior."""
...
def test_native_list_and_verify_paths(tmp_path: Path) -> None:
    """Verify native list and verify paths behavior."""
    import sys
