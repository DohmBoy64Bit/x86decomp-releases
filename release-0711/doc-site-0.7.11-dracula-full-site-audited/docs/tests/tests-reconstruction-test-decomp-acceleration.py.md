...
description: Test source page for tests/reconstruction/test_decomp_acceleration.py.
---
...
```python
"""Verify the current toolkit behavior covered by `tests/reconstruction/test_decomp_acceleration.py`."""
...
def test_llm_job_create_and_range(tmp_path: Path) -> None:
    """Verify llm job create and range behavior."""
...
def test_source_map_and_candidate_promotion(tmp_path: Path) -> None:
    """Verify source map and candidate promotion behavior."""
...
def test_planning_helpers(tmp_path: Path) -> None:
    """Verify planning helpers behavior."""
    project = tmp_path / "project"
