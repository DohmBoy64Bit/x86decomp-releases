...
description: Test source page for test-suite/tests/test_config_models.py.
---
...
```python
"""Provide test-suite.tests.test_config_models functionality for the x86decomp-toolkit 0.7.11 release.
