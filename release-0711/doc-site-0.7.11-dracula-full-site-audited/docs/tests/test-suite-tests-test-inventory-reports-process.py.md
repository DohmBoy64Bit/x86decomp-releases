...
description: Test source page for test-suite/tests/test_inventory_reports_process.py.
---

# `test-suite/tests/test_inventory_reports_process.py`

- SHA-256: `5f373ffc72fdbeefc5126f76eac31a7052181a5c2004318cb8c6d33678720b4d`
- Size: `6641` bytes
- Test functions: `4`

```python
"""Provide test-suite.tests.test_inventory_reports_process functionality for the x86decomp-toolkit 0.7.11 release.
