...
description: Test source page for tests/test_decompme_objdiff.py.
---
...
```python
"""Verify the current toolkit behavior covered by `tests/test_decompme_objdiff.py`."""
...
def test_create_local_decompme_packet(tmp_path: Path) -> None:
    """Verify create local decompme packet behavior."""
...
def test_manifest_driven_objdiff_adapter(tmp_path: Path) -> None:
    """Verify manifest driven objdiff adapter behavior."""
