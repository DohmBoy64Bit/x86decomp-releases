---
title: Local LLM
description: Local LLM workflow for x86decomp 0.7.11.
---
...
## 0.7.11 decompilation acceleration loop

0.7.11 adds the missing job materialization and queue-management layer around the existing local-model proposal loop:
