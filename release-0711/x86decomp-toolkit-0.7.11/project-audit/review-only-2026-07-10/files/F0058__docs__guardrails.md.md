# Per-file audit: `docs/guardrails.md`

## A. File Identity

- **Inventory ID:** `F0058`
- **Relative path:** `docs/guardrails.md`
- **SHA-256:** `c900c3cf8ad5d8631d14f8325e4c130d75c4c16a73fb53b6ce6ae0dc5d09134f`
- **File size:** 2367 bytes
- **Language/format:** Markdown
- **Classification:** Documentation
- **Apparent responsibility:** Documentation centered on 'Guardrails'.
...
Documentation centered on 'Guardrails'. Principal sections: Guardrails; Factual guardrails; Execution guardrails; Mutation guardrails; Path and artifact guardrails; AI guardrails.
