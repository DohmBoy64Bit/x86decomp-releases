# Per-file audit: `tests/test_modes_and_db.py`

## A. File Identity

- **Inventory ID:** `F0533`
- **Relative path:** `tests/test_modes_and_db.py`
- **SHA-256:** `84554d4fd263de392d7d3e43471ad0b538672e354b28b1ad639ccbd8f5a60f94`
...
- **Key imports/dependencies:** `pathlib`, `pe_fixture`, `pytest`, `x86decomp.analysis_db`, `x86decomp.errors`, `x86decomp.project`, `x86decomp.workflow`

## B. Functional Summary

Executable regression tests for the behavior indicated by the filename and test symbols. Major symbols: test_independent_modes_and_monotonic_state, test_type_constraint_conflict_gate. No side-effect-relevant call matched the audit scanner’s rule set.
...
Highest structural complexity: test_independent_modes_and_monotonic_state (branches=0, AST nodes=122), test_type_constraint_conflict_gate (branches=0, AST nodes=81).
