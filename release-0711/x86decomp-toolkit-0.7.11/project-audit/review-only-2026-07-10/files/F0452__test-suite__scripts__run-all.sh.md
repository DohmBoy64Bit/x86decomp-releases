# Per-file audit: `test-suite/scripts/run-all.sh`

## A. File Identity

- **Inventory ID:** `F0452`
- **Relative path:** `test-suite/scripts/run-all.sh`
- **SHA-256:** `b2ed622ebf3f48fd4735088604e027152df7d446d4283fc63235d81b5c0caef2`
- **File size:** 114 bytes
- **Language/format:** POSIX shell
- **Classification:** Test code
- **Apparent responsibility:** Repository posix shell asset.
