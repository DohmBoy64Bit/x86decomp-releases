# Per-file audit: `tests/governance/test_governance_cli_schemas.py`

## A. File Identity

- **Inventory ID:** `F0498`
- **Relative path:** `tests/governance/test_governance_cli_schemas.py`
- **SHA-256:** `cc3bf372d33b03ab7efdf043ec2bc7c5328bc623bcdab6b4223d18076161e424`
...
- **Key imports/dependencies:** `__future__`, `json`, `jsonschema`, `pathlib`, `pytest`, `x86decomp.cli_utils`, `x86decomp.contracts`, `x86decomp.governance.cli`

## B. Functional Summary

Executable regression tests for the behavior indicated by the filename and test symbols. Major symbols: test_every_governance_schema_meta_validates, test_governance_cli_help_and_init, test_governance_cli_hypothesis_flow, test_contract_helpers_and_cli_json_arg, test_all_governance_leaf_commands_parse_help, test_all_governance_leaf_commands_parse_help.walk. No side-effect-relevant call matched the audit scanner’s rule set.
...
Highest structural complexity: test_all_governance_leaf_commands_parse_help (branches=5, AST nodes=150), test_all_governance_leaf_commands_parse_help.walk (branches=4, AST nodes=80), test_every_governance_schema_meta_validates (branches=1, AST nodes=50), test_contract_helpers_and_cli_json_arg (branches=0, AST nodes=107), test_governance_cli_hypothesis_flow (branches=0, AST nodes=93).
...
Executed in the exact inventory: 5 collected test(s), all passing.
...
- **Test confidence:** Executed in the exact inventory: 5 collected test(s), all passing.
