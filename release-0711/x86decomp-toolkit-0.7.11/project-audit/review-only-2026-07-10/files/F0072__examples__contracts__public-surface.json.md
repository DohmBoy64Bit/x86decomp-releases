# Per-file audit: `examples/contracts/public-surface.json`

## A. File Identity

- **Inventory ID:** `F0072`
- **Relative path:** `examples/contracts/public-surface.json`
- **SHA-256:** `d04d7f8622da4eb0c103fd7515720a32265ae6336e410bfa5358398f9d975fda`
- **File size:** 43011 bytes
- **Language/format:** JSON
- **Classification:** Example or sample
- **Apparent responsibility:** Structured repository data with top-level keys: adapter_ids, canonical_groups, canonical_routes, commands, entry_points, ghidra_scripts, modules, purpose.
...
Structured repository data with top-level keys: adapter_ids, canonical_groups, canonical_routes, commands, entry_points, ghidra_scripts, modules, purpose. JSON parsing was verified; top-level type is dict.
