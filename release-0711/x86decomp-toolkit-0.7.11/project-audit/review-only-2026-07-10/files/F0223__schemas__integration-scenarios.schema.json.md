# Per-file audit: `schemas/integration-scenarios.schema.json`

## A. File Identity

- **Inventory ID:** `F0223`
- **Relative path:** `schemas/integration-scenarios.schema.json`
...
- **Apparent responsibility:** Structured repository data with top-level keys: $schema, $id, title, type, additionalProperties, required, properties, $defs.
...
Structured repository data with top-level keys: $schema, $id, title, type, additionalProperties, required, properties, $defs. JSON parsing was verified; top-level type is dict.
