# Per-file audit: `docs/adapter-capabilities.md`

## A. File Identity

- **Inventory ID:** `F0052`
- **Relative path:** `docs/adapter-capabilities.md`
- **SHA-256:** `7ab50fd37db0daf4b5776422645a7984784998c6c8241302e93d9867405b8cc3`
- **File size:** 1020 bytes
- **Language/format:** Markdown
- **Classification:** Documentation
- **Apparent responsibility:** Documentation centered on 'Adapter capabilities — 0.7.11'.
...
Documentation centered on 'Adapter capabilities — 0.7.11'. Principal sections: Adapter capabilities — 0.7.11.
