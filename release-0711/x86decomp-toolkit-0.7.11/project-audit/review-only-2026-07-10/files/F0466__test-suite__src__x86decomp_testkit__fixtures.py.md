# Per-file audit: `test-suite/src/x86decomp_testkit/fixtures.py`

## A. File Identity

- **Inventory ID:** `F0466`
- **Relative path:** `test-suite/src/x86decomp_testkit/fixtures.py`
- **SHA-256:** `81d8fbe31a4754053ad7160772253d3a133ce9935d0bde3eb3c1e8810f058815`
- **File size:** 5694 bytes
- **Language/format:** Python source
- **Classification:** First-party verification-harness source
- **Apparent responsibility:** Provide the installed test-suite implementation for the `x86decomp_testkit.fixtures` module.
- **Provenance:** First-party or repository-maintained text
- **Review applicability:** Complete-content text/source review
- **Related files / static consumers:** `test-suite/src/x86decomp_testkit/live_adapters.py`, `test-suite/src/x86decomp_testkit/toolkit_tests/test_public_api_contract.py`
- **Key imports/dependencies:** `__future__`, `json`, `pathlib`, `struct`, `typing`

## B. Functional Summary

Provide the installed test-suite implementation for the `x86decomp_testkit.fixtures` module. Major symbols: write_json, build_minimal_pe32, build_minimal_pe64, create_common_fixtures. Static analysis recorded 7 filesystem, process, database, network, or other side-effect-relevant call(s).
...
Python parsed successfully with the standard-library AST parser. Side-effect/trust-sensitive calls reviewed: path.parent.mkdir×3, path.write_bytes×2, path.write_text×1, root.mkdir×1.
...
Highest structural complexity: build_minimal_pe64 (branches=0, AST nodes=414), build_minimal_pe32 (branches=0, AST nodes=404), create_common_fixtures (branches=0, AST nodes=223), write_json (branches=0, AST nodes=49).
