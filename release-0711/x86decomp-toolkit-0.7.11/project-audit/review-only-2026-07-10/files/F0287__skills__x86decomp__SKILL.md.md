# Per-file audit: `skills/x86decomp/SKILL.md`

## A. File Identity

- **Inventory ID:** `F0287`
- **Relative path:** `skills/x86decomp/SKILL.md`
- **SHA-256:** `f8bff9e63605d3137355dafa5383c3eba7e3aba681bde1ce8d06f19fdf4a4dff`
- **File size:** 4680 bytes
- **Language/format:** Markdown
- **Classification:** Documentation
- **Apparent responsibility:** Documentation centered on 'x86decomp evidence engineer'.
...
Documentation centered on 'x86decomp evidence engineer'. Principal sections: x86decomp evidence engineer; Interface; Non-negotiable rules; Evidence vocabulary; Workflow.
