# Per-file audit: `src/x86decomp/harness_generator.py`

## A. File Identity

- **Inventory ID:** `F0364`
- **Relative path:** `src/x86decomp/harness_generator.py`
- **SHA-256:** `8b2651a7e986342fe91ca248d9b5514df815e7a4ee7f49c86044fdebc5c45494`
- **File size:** 7077 bytes
- **Language/format:** Python source
- **Classification:** First-party source code
- **Apparent responsibility:** Generate bounded differential-execution harnesses from explicit ABI facts.
...
- **Key imports/dependencies:** `.abi`, `.errors`, `.util`, `__future__`, `pathlib`, `typing`

## B. Functional Summary

Generate bounded differential-execution harnesses from explicit ABI facts. Major symbols: generate_execution_harness, generate_execution_harness_from_files. No side-effect-relevant call matched the audit scanner’s rule set.
...
Highest structural complexity: generate_execution_harness (branches=27, AST nodes=901), generate_execution_harness_from_files (branches=2, AST nodes=118), _deterministic_word (branches=0, AST nodes=36).
...
Static search found direct symbol references in tests: generate_execution_harness(4), generate_execution_harness_from_files(3). The exact 258-test inventory passed; this is evidence of use, not a line-coverage claim.
...
- **Test confidence:** Static search found direct symbol references in tests: generate_execution_harness(4), generate_execution_harness_from_files(3). The exact 258-test inventory passed; this is evidence of use, not a line-coverage claim.
