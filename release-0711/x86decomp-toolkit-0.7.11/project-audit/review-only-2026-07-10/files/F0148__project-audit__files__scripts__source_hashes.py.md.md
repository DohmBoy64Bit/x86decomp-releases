# Per-file audit: `project-audit/files/scripts__source_hashes.py.md`

## A. File Identity

- **Inventory ID:** `F0148`
- **Relative path:** `project-audit/files/scripts__source_hashes.py.md`
- **SHA-256:** `bd22675f4fb2f7425d4c5e521dc70cf47a4393bec3a28bd17d413fc278ccbd92`
...
Historical human-readable audit evidence or per-file review. Principal sections: Per-file audit — scripts/source_hashes.py; A. Identity; B. Function (read fully, 161 lines); C. Correctness — Verified by execution (R-016); M. Verdict.
