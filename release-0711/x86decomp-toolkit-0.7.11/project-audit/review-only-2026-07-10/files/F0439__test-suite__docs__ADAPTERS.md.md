# Per-file audit: `test-suite/docs/ADAPTERS.md`

## A. File Identity

- **Inventory ID:** `F0439`
- **Relative path:** `test-suite/docs/ADAPTERS.md`
- **SHA-256:** `dcbf62259392c91cafcacdae8c21510d1c902cb7d5ad82356e97d0d0ab1ba307`
- **File size:** 3754 bytes
- **Language/format:** Markdown
- **Classification:** Documentation
- **Apparent responsibility:** Documentation centered on 'Adapter detection, installation, and live-test contract'.
...
Documentation centered on 'Adapter detection, installation, and live-test contract'. Principal sections: Adapter detection, installation, and live-test contract; Detection order; Adapter identity versus protocol capability; LM Studio HTTP endpoint; Installation consent; Adapter families; Live probes; Download safety.
