# Per-file audit: `project-audit/files/src__x86decomp__cli.py.md`

## A. File Identity

- **Inventory ID:** `F0160`
- **Relative path:** `project-audit/files/src__x86decomp__cli.py.md`
- **SHA-256:** `59e6ed8d5a46d70314da0630f3d102abbf2df89ec4ea5b543f5a6020da80266f`
...
Historical human-readable audit evidence or per-file review. Principal sections: Per-file audit — src/x86decomp/cli.py; A. Identity; B. Function (read fully, 450 lines); C. Correctness; D. Documentation; E. Maintainability; F. AI indicators; I. Testing.
