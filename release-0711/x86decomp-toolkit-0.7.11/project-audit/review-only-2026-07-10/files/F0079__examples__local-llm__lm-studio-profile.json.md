# Per-file audit: `examples/local-llm/lm-studio-profile.json`

## A. File Identity

- **Inventory ID:** `F0079`
- **Relative path:** `examples/local-llm/lm-studio-profile.json`
- **SHA-256:** `f8135459f4354bf16ab4797924efb4a02f44b494ac36ee4873464609307c202e`
- **File size:** 498 bytes
- **Language/format:** JSON
- **Classification:** Example or sample
- **Apparent responsibility:** Structured repository data with top-level keys: schema_version, id, provider, protocol, base_url, models_path, chat_path, structured_output.
...
Structured repository data with top-level keys: schema_version, id, provider, protocol, base_url, models_path, chat_path, structured_output. JSON parsing was verified; top-level type is dict.
