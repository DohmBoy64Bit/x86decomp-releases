# Per-file audit: `project-audit/files/src__x86decomp__compiler.py.md`

## A. File Identity

- **Inventory ID:** `F0164`
- **Relative path:** `project-audit/files/src__x86decomp__compiler.py.md`
- **SHA-256:** `7344c9d109d7168e9910c0da524a2209917c17c1cdf6ffe2740d653b9bfae089`
- **File size:** 972 bytes
...
Historical human-readable audit evidence or per-file review. Principal sections: Per-file audit — src/x86decomp/compiler.py; A. Identity; B. Function (read fully, 238 lines); C/H. Security; M. Verdict.
