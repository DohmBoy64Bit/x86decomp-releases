# Per-file audit: `test-suite/src/x86decomp_testkit/config.py`

## A. File Identity

- **Inventory ID:** `F0463`
- **Relative path:** `test-suite/src/x86decomp_testkit/config.py`
- **SHA-256:** `89da2f134e851e4c23f58842500ad795c2b728444d9f3237dd5557e2efec2bd2`
- **File size:** 4444 bytes
- **Language/format:** Python source
- **Classification:** First-party verification-harness source
- **Apparent responsibility:** Provide the installed test-suite implementation for the `x86decomp_testkit.config` module.
- **Provenance:** First-party or repository-maintained text
- **Review applicability:** Complete-content text/source review
- **Related files / static consumers:** `test-suite/src/x86decomp_testkit/adapters/capabilities.py`, `test-suite/src/x86decomp_testkit/adapters/detection.py`, `test-suite/src/x86decomp_testkit/adapters/installation.py`, `test-suite/src/x86decomp_testkit/cli.py`, `test-suite/src/x86decomp_testkit/live_adapters.py`, `test-suite/src/x86decomp_testkit/orchestrator.py`, `test-suite/src/x86decomp_testkit/self_tests/test_adapter_capabilities.py`, `test-suite/src/x86decomp_testkit/self_tests/test_adapter_detection_resolution.py`
- **Key imports/dependencies:** `__future__`, `dataclasses`, `json`, `os`, `pathlib`, `typing`

## B. Functional Summary

Provide the installed test-suite implementation for the `x86decomp_testkit.config` module. Major symbols: TestConfig, load_config, save_config, TestConfig.to_dict, TestConfig.from_dict, TestConfig.from_dict.resolve. Static analysis recorded 2 filesystem, process, database, network, or other side-effect-relevant call(s).
...
Highest structural complexity: TestConfig.from_dict (branches=4, AST nodes=338), TestConfig.from_dict.resolve (branches=1, AST nodes=54), load_config (branches=1, AST nodes=51), TestConfig.to_dict (branches=0, AST nodes=127), save_config (branches=0, AST nodes=48).
