# Per-file audit: `examples/integration/candidate.py`

## A. File Identity

- **Inventory ID:** `F0074`
- **Relative path:** `examples/integration/candidate.py`
- **SHA-256:** `2b348feb64cd2832d57b07c74cd35c58a2b9c36916263a04b3d80bc0c377b8b3`
- **File size:** 240 bytes
...
- **Key imports/dependencies:** `pathlib`, `sys`

## B. Functional Summary

Repository python source asset. It defines no public Python symbols. No side-effect-relevant call matched the audit scanner’s rule set.
