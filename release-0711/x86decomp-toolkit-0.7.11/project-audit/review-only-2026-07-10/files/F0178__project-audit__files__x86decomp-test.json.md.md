# Per-file audit: `project-audit/files/x86decomp-test.json.md`

## A. File Identity

- **Inventory ID:** `F0178`
- **Relative path:** `project-audit/files/x86decomp-test.json.md`
- **SHA-256:** `106a73295e14170ad80dbe3b9e6a16c04711f69d9d9ac6a19c9211db957bc9e2`
...
Historical human-readable audit evidence or per-file review. Principal sections: Per-file audit — x86decomp-test.json; A. Identity; B. Function; C/H. Review; L. Findings; M. Verdict.
