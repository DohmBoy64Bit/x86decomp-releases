# Per-file audit: `src/x86decomp/corpus/ground_truth_sources/member_pointers.cpp`

## A. File Identity

- **Inventory ID:** `F0326`
- **Relative path:** `src/x86decomp/corpus/ground_truth_sources/member_pointers.cpp`
- **SHA-256:** `8e84a7254ebeda7ec4db40335350606cf26227868e20be7db4f4382cdd3e9f69`
- **File size:** 299 bytes
