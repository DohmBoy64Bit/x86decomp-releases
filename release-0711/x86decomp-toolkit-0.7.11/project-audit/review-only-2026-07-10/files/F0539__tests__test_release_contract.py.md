# Per-file audit: `tests/test_release_contract.py`

## A. File Identity

- **Inventory ID:** `F0539`
- **Relative path:** `tests/test_release_contract.py`
- **SHA-256:** `58a52322e34305d498e874035017b6b4b5190e0b66c7eb93cb428113409a953a`
- **File size:** 10242 bytes
...
- **Key imports/dependencies:** `__future__`, `ast`, `importlib.util`, `json`, `jsonschema`, `pathlib`, `re`, `tomllib`, `x86decomp`, `x86decomp.canonical`, `x86decomp.cli`, `x86decomp_testkit.adapters`, `x86decomp_testkit.inventory`

## B. Functional Summary

Executable regression tests for the behavior indicated by the filename and test symbols. Major symbols: test_current_command_and_schema_contract, test_schema_project_and_function_documents_remain_valid, test_ground_truth_sources_are_packaged_and_in_sync, test_current_public_surface_contract, test_exact_recursive_feature_catalog_matches_current_tree, test_repository_contains_only_the_current_release_contract, test_no_placeholder_implementations_in_current_python_sources, test_deterministic_source_hash_tool_detects_drift, test_flat_compatibility_aliases_are_explicit. No side-effect-relevant call matched the audit scanner’s rule set.
...
Highest structural complexity: test_repository_contains_only_the_current_release_contract (branches=18, AST nodes=513), test_no_placeholder_implementations_in_current_python_sources (branches=13, AST nodes=289), test_current_public_surface_contract (branches=4, AST nodes=211), test_ground_truth_sources_are_packaged_and_in_sync (branches=2, AST nodes=89), test_deterministic_source_hash_tool_detects_drift (branches=1, AST nodes=185). 1 line(s) exceed 140 characters; this is a maintainability signal, not by itself a defect.
...
Executed in the exact inventory: 9 collected test(s), all passing.
...
- **Test confidence:** Executed in the exact inventory: 9 collected test(s), all passing.
