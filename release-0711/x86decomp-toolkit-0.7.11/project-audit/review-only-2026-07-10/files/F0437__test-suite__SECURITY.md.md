# Per-file audit: `test-suite/SECURITY.md`

## A. File Identity

- **Inventory ID:** `F0437`
- **Relative path:** `test-suite/SECURITY.md`
- **SHA-256:** `4af92df1455941633efd7e47b34c20a9c3f3a5914406c3475cc464d068f1a625`
- **File size:** 633 bytes
- **Language/format:** Markdown
- **Classification:** Documentation
- **Apparent responsibility:** Documentation centered on 'Test-suite security model — 0.7.11'.
...
Documentation centered on 'Test-suite security model — 0.7.11'. Principal sections: Test-suite security model — 0.7.11.
