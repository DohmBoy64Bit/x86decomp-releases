# Per-file audit: `docs/contracts.md`

## A. File Identity

- **Inventory ID:** `F0055`
- **Relative path:** `docs/contracts.md`
- **SHA-256:** `ca03911160dff537c0320208dc20b8dff7d8b44617d2344f40cedd72f28707cd`
- **File size:** 4497 bytes
- **Language/format:** Markdown
- **Classification:** Documentation
- **Apparent responsibility:** Documentation centered on 'Document and state contracts'.
...
Documentation centered on 'Document and state contracts'. Principal sections: Document and state contracts; Stable identity; Mode contract; Matching status contract; Functional status contract; Evidence contract; Claim contract; Compiler contract.
...
14 Markdown heading(s) structure the document; local targets were checked repository-wide.
