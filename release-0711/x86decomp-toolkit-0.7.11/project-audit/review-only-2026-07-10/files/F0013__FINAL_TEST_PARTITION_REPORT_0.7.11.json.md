# Per-file audit: `FINAL_TEST_PARTITION_REPORT_0.7.11.json`

## A. File Identity

- **Inventory ID:** `F0013`
- **Relative path:** `FINAL_TEST_PARTITION_REPORT_0.7.11.json`
- **SHA-256:** `3af53a95e608a01b2856d14261992fb26bcc51e0ae084fec59f7805fada8239b`
- **File size:** 24190 bytes
- **Language/format:** JSON
- **Classification:** Generated verification artifact
- **Apparent responsibility:** Structured repository data with top-level keys: collected, errors, failures, missing_partitions, partition_count, passed, records, runner.
...
Structured repository data with top-level keys: collected, errors, failures, missing_partitions, partition_count, passed, records, runner. JSON parsing was verified; top-level type is dict.
