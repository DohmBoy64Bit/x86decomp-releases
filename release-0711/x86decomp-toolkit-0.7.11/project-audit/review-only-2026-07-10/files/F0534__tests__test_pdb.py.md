# Per-file audit: `tests/test_pdb.py`

## A. File Identity

- **Inventory ID:** `F0534`
- **Relative path:** `tests/test_pdb.py`
- **SHA-256:** `a66327c79f20e3a5c0ee0590777772b5b75fd514abda9f05374e15cd0c8f034f`
...
- **Key imports/dependencies:** `__future__`, `pathlib`, `pytest`, `shutil`, `subprocess`, `x86decomp.errors`, `x86decomp.pdb`, `x86decomp.test_bundle`

## B. Functional Summary

Executable regression tests for the behavior indicated by the filename and test symbols. Major symbols: test_invalid_pdb_is_rejected, test_real_lld_pdb_inventory_identity_and_bundle. Static analysis recorded 3 filesystem, process, database, network, or other side-effect-relevant call(s).
...
Python parsed successfully with the standard-library AST parser. Side-effect/trust-sensitive calls reviewed: subprocess.run×2, source.write_text×1.
...
Highest structural complexity: test_real_lld_pdb_inventory_identity_and_bundle (branches=2, AST nodes=396), test_invalid_pdb_is_rejected (branches=0, AST nodes=21).
