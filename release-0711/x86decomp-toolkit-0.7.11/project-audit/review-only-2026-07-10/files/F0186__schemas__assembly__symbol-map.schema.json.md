# Per-file audit: `schemas/assembly/symbol-map.schema.json`

## A. File Identity

- **Inventory ID:** `F0186`
- **Relative path:** `schemas/assembly/symbol-map.schema.json`
...
- **Apparent responsibility:** Structured repository data with top-level keys: $schema, $id, title, type, additionalProperties.
...
Structured repository data with top-level keys: $schema, $id, title, type, additionalProperties. JSON parsing was verified; top-level type is dict.
