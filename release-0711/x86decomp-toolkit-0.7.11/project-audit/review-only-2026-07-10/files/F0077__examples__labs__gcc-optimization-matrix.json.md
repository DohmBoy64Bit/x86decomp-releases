# Per-file audit: `examples/labs/gcc-optimization-matrix.json`

## A. File Identity

- **Inventory ID:** `F0077`
- **Relative path:** `examples/labs/gcc-optimization-matrix.json`
- **SHA-256:** `f4f19ea47da16374312c4eff46d2914e3d0c425a229f92a95b2fe99221acbd78`
- **File size:** 376 bytes
- **Language/format:** JSON
- **Classification:** Example or sample
- **Apparent responsibility:** Structured repository data with top-level keys: source, profiles, output_root, cache_root, output_name, max_experiments, matrix, target.
...
Structured repository data with top-level keys: source, profiles, output_root, cache_root, output_name, max_experiments, matrix, target. JSON parsing was verified; top-level type is dict.
