# Per-file audit: `tests/test_docstring_audit.py`

## A. File Identity

- **Inventory ID:** `F0522`
- **Relative path:** `tests/test_docstring_audit.py`
- **SHA-256:** `21d346e4c07e552ee8c635a91030480a0ee28a595ba566ffac35e4a3b5a0d4ee`
...
- **Key imports/dependencies:** `__future__`, `ast`, `json`, `pathlib`, `x86decomp.canonical`, `x86decomp.cli`

## B. Functional Summary

Executable regression tests for the behavior indicated by the filename and test symbols. Major symbols: test_every_python_symbol_has_a_docstring, test_docstring_audit_report_matches_current_release, test_command_reference_matches_canonical_surface. No side-effect-relevant call matched the audit scanner’s rule set.
...
Highest structural complexity: test_every_python_symbol_has_a_docstring (branches=5, AST nodes=148), _python_files (branches=5, AST nodes=82), test_command_reference_matches_canonical_surface (branches=1, AST nodes=98), test_docstring_audit_report_matches_current_release (branches=0, AST nodes=89).
