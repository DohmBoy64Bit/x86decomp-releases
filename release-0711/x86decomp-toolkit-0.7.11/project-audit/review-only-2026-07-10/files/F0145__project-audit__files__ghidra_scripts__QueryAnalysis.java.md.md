# Per-file audit: `project-audit/files/ghidra_scripts__QueryAnalysis.java.md`

## A. File Identity

- **Inventory ID:** `F0145`
- **Relative path:** `project-audit/files/ghidra_scripts__QueryAnalysis.java.md`
- **SHA-256:** `7781879dd861c440b10887b117f5eb00f1a4c0847ea0daca7d7c54ebd8a1ee10`
- **File size:** 594 bytes
...
Historical human-readable audit evidence or per-file review. Principal sections: Per-file audit — ghidra_scripts/QueryAnalysis.java; A. Identity; B. Function (read fully, 190 lines); M. Verdict.
