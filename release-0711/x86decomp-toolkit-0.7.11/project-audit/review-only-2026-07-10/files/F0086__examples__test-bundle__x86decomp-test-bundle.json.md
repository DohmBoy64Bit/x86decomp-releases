# Per-file audit: `examples/test-bundle/x86decomp-test-bundle.json`

## A. File Identity

- **Inventory ID:** `F0086`
- **Relative path:** `examples/test-bundle/x86decomp-test-bundle.json`
- **SHA-256:** `6d88af2c016e6e88a5ba66fab7c88c9d7b56f70c1f5e71d2cb494aab69da6a68`
- **File size:** 593 bytes
- **Language/format:** JSON
- **Classification:** Example or sample
- **Apparent responsibility:** Structured repository data with top-level keys: schema_version, name, description, expected_architecture, authorization, artifacts.
...
Structured repository data with top-level keys: schema_version, name, description, expected_architecture, authorization, artifacts. JSON parsing was verified; top-level type is dict.
