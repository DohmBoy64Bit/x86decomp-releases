# Per-file audit: `tests/test_dynamic_symbolic.py`

## A. File Identity

- **Inventory ID:** `F0524`
- **Relative path:** `tests/test_dynamic_symbolic.py`
- **SHA-256:** `7b601226798d54a0e509cc81282a1372384b26a75fae690d62399d3c01e89f12`
...
- **Key imports/dependencies:** `importlib.util`, `pytest`, `x86decomp.dynamic`, `x86decomp.errors`, `x86decomp.symbolic`

## B. Functional Summary

Executable regression tests for the behavior indicated by the filename and test symbols. Major symbols: test_dynamic_equivalence_and_difference, test_symbolic_bounded_equivalence. No side-effect-relevant call matched the audit scanner’s rule set.
...
Highest structural complexity: test_symbolic_bounded_equivalence (branches=2, AST nodes=99), test_dynamic_equivalence_and_difference (branches=1, AST nodes=117).
