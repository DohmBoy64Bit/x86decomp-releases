# Per-file audit: `docs/test-bundle.md`

## A. File Identity

- **Inventory ID:** `F0067`
- **Relative path:** `docs/test-bundle.md`
- **SHA-256:** `a46690243ada69526ce92db7b4f667a8aea677db98a286c5a56ff7b18af9f113`
- **File size:** 4551 bytes
- **Language/format:** Markdown
- **Classification:** Documentation
- **Apparent responsibility:** Documentation centered on 'Authorized static test bundles'.
...
Documentation centered on 'Authorized static test bundles'. Principal sections: Authorized static test bundles; Best bundle contents; Create a bundle; Inspect a bundle; Manifest contract; Archive guardrails.
