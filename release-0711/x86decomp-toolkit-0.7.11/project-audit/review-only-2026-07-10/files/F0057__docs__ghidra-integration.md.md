# Per-file audit: `docs/ghidra-integration.md`

## A. File Identity

- **Inventory ID:** `F0057`
- **Relative path:** `docs/ghidra-integration.md`
- **SHA-256:** `c60e3ad7b722d1063d4a11e59e5225ddc5e1468781917992db958aba7387006a`
- **File size:** 1690 bytes
- **Language/format:** Markdown
- **Classification:** Documentation
- **Apparent responsibility:** Documentation centered on 'Ghidra integration'.
...
Documentation centered on 'Ghidra integration'. Principal sections: Ghidra integration; Baseline and verification; Exports; Interpretation rules; MCP.
