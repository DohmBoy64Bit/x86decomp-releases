# Per-file audit: `test-suite/README.md`

## A. File Identity

- **Inventory ID:** `F0436`
- **Relative path:** `test-suite/README.md`
- **SHA-256:** `08e7aa0d1bc2dacd2430cd9ac0f9955ba48af79b3567edf1fdb5489953c26f14`
- **File size:** 1626 bytes
- **Language/format:** Markdown
- **Classification:** Documentation
- **Apparent responsibility:** Documentation centered on 'x86decomp comprehensive test suite 0.7.11'.
...
Documentation centered on 'x86decomp comprehensive test suite 0.7.11'. Principal sections: x86decomp comprehensive test suite 0.7.11; Interface; Current pinned surface; Result policy; 0.7.11 adapter-capability note.
