# Per-file audit: `src/x86decomp/reconstruction/__init__.py`

## A. File Identity

- **Inventory ID:** `F0399`
- **Relative path:** `src/x86decomp/reconstruction/__init__.py`
- **SHA-256:** `52313d0bee948e0909b7dbad630958a9631187f643927aa9b604acf3184599c8`
- **File size:** 179 bytes
- **Language/format:** Python source
- **Classification:** First-party source code
- **Apparent responsibility:** Project-scale reconstruction and proof-carrying source capabilities.
...
- **Key imports/dependencies:** `.store`

## B. Functional Summary

Project-scale reconstruction and proof-carrying source capabilities. It defines no public Python symbols. No side-effect-relevant call matched the audit scanner’s rule set.
