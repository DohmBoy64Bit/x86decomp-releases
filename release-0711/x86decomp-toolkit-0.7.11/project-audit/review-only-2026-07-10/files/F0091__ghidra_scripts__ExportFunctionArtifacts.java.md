...
- **Inventory ID:** `F0091`
- **Relative path:** `ghidra_scripts/ExportFunctionArtifacts.java`
- **SHA-256:** `2c1a21482d49c2bdd2fcf86e6df9d3c401fc4e5e4c4a36ea358aa9e2ddf6ca49`
- **File size:** 24555 bytes
- **Language/format:** Java source
- **Classification:** First-party Ghidra integration source
- **Apparent responsibility:** Ghidra-side integration script source.
...
Ghidra-side integration script source.
