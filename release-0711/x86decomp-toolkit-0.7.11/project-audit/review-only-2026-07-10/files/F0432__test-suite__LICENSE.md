# Per-file audit: `test-suite/LICENSE`

## A. File Identity

- **Inventory ID:** `F0432`
- **Relative path:** `test-suite/LICENSE`
- **SHA-256:** `469b8fd4bf8c3ead57817703e5a8ea98c7759304f0da851b57810e410decffc5`
- **File size:** 587 bytes
- **Language/format:** UTF-8 text
- **Classification:** License metadata
- **Apparent responsibility:** License notice distributed with the relevant package.
...
License notice distributed with the relevant package.
