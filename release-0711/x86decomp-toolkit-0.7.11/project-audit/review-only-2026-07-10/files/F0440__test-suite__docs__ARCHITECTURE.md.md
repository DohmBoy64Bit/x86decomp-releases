# Per-file audit: `test-suite/docs/ARCHITECTURE.md`

## A. File Identity

- **Inventory ID:** `F0440`
- **Relative path:** `test-suite/docs/ARCHITECTURE.md`
- **SHA-256:** `4450716f9c6ff79d4f8a795438cb19c851cdf81cca9967e14212041a100add84`
- **File size:** 412 bytes
- **Language/format:** Markdown
- **Classification:** Documentation
- **Apparent responsibility:** Documentation centered on 'Test-suite architecture — 0.7.11'.
...
Documentation centered on 'Test-suite architecture — 0.7.11'. Principal sections: Test-suite architecture — 0.7.11.
