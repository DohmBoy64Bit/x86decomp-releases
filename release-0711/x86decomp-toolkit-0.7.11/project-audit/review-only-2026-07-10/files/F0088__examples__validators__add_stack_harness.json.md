# Per-file audit: `examples/validators/add_stack_harness.json`

## A. File Identity

- **Inventory ID:** `F0088`
- **Relative path:** `examples/validators/add_stack_harness.json`
- **SHA-256:** `beeaeeecbe1136402ef0b3c1c3f799256a2613f87bb9457f97b71fe605ec0d0f`
- **File size:** 346 bytes
- **Language/format:** JSON
- **Classification:** Example or sample
- **Apparent responsibility:** Structured repository data with top-level keys: architecture, code_base, stack_base, stack_size, sentinel_address, max_instructions, timeout_ms, registers.
...
Structured repository data with top-level keys: architecture, code_base, stack_base, stack_size, sentinel_address, max_instructions, timeout_ms, registers. JSON parsing was verified; top-level type is dict.
