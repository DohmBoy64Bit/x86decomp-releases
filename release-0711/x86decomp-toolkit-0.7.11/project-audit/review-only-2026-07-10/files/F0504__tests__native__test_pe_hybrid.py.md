# Per-file audit: `tests/native/test_pe_hybrid.py`

## A. File Identity

- **Inventory ID:** `F0504`
- **Relative path:** `tests/native/test_pe_hybrid.py`
...
- **Key imports/dependencies:** `pathlib`, `pe_fixture`, `pytest`, `x86decomp.contracts`, `x86decomp.native.hybrid_composer`, `x86decomp.native.matching`, `x86decomp.native.pe_reconstruction`, `x86decomp.native.store`, `x86decomp.pe`

## B. Functional Summary

Executable regression tests for the behavior indicated by the filename and test symbols. Major symbols: test_safe_patch_and_text_swap_preserve_pe_container, test_section_export_and_synthetic_coff_for_pe32_and_pe64, test_hybrid_composer_promotes_only_verified_candidates, test_hybrid_composer_rejects_candidate_changed_after_match. Static analysis recorded 5 filesystem, process, database, network, or other side-effect-relevant call(s).
...
Python parsed successfully with the standard-library AST parser. Side-effect/trust-sensitive calls reviewed: candidate.write_bytes×2, replacement.write_bytes×1, good.write_bytes×1, bad.write_bytes×1.
...
Highest structural complexity: test_hybrid_composer_promotes_only_verified_candidates (branches=1, AST nodes=193), test_safe_patch_and_text_swap_preserve_pe_container (branches=1, AST nodes=155), test_section_export_and_synthetic_coff_for_pe32_and_pe64 (branches=1, AST nodes=129), test_hybrid_composer_rejects_candidate_changed_after_match (branches=0, AST nodes=115). 2 line(s) exceed 140 characters; this is a maintainability signal, not by itself a defect.
