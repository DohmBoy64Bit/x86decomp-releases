# Per-file audit: `examples/abi/stdcall-two-ints.json`

## A. File Identity

- **Inventory ID:** `F0068`
- **Relative path:** `examples/abi/stdcall-two-ints.json`
- **SHA-256:** `f2c7a723de83de7169612e1cdc305a4bd8779e9ad82c7ff3a2ce90d400ac3ace`
- **File size:** 275 bytes
- **Language/format:** JSON
- **Classification:** Example or sample
- **Apparent responsibility:** Structured repository data with top-level keys: architecture, convention, stack_argument_bytes, callee_stack_cleanup, variadic, this_register, register_arguments, return_registers.
...
Structured repository data with top-level keys: architecture, convention, stack_argument_bytes, callee_stack_cleanup, variadic, this_register, register_arguments, return_registers. JSON parsing was verified; top-level type is dict.
