# Per-file audit: `tests/test_abi_disassembly.py`

## A. File Identity

- **Inventory ID:** `F0514`
- **Relative path:** `tests/test_abi_disassembly.py`
...
- **Key imports/dependencies:** `importlib.util`, `pytest`, `x86decomp.abi`, `x86decomp.errors`

## B. Functional Summary

Executable regression tests for the behavior indicated by the filename and test symbols. Major symbols: test_stdcall_ret_cleanup. No side-effect-relevant call matched the audit scanner’s rule set.
...
Highest structural complexity: test_stdcall_ret_cleanup (branches=1, AST nodes=86).
