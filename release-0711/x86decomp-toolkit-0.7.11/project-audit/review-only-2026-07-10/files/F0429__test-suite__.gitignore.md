# Per-file audit: `test-suite/.gitignore`

## A. File Identity

- **Inventory ID:** `F0429`
- **Relative path:** `test-suite/.gitignore`
- **SHA-256:** `a436e3b7faa06acfab37ac4d6870f732d0eee90f2d8d5095d25af8fa4af2d2db`
- **File size:** 195 bytes
- **Language/format:** Git ignore rules
- **Classification:** Configuration or packaging
- **Apparent responsibility:** Repository git ignore rules asset.
...
Repository git ignore rules asset.
