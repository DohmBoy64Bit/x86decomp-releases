# Per-file audit: `test-suite/src/x86decomp_testkit/models.py`

## A. File Identity

- **Inventory ID:** `F0471`
- **Relative path:** `test-suite/src/x86decomp_testkit/models.py`
- **SHA-256:** `7e7165144706bae0c882c704eec1a727da6ffbc213825b2a2c4bd475007ee481`
- **File size:** 4650 bytes
- **Language/format:** Python source
- **Classification:** First-party verification-harness source
- **Apparent responsibility:** Provide the installed test-suite implementation for the `x86decomp_testkit.models` module.
- **Provenance:** First-party or repository-maintained text
- **Review applicability:** Complete-content text/source review
- **Related files / static consumers:** `src/x86decomp/cli.py`, `src/x86decomp/evidence.py`, `test-suite/src/x86decomp_testkit/adapters/capabilities.py`, `test-suite/src/x86decomp_testkit/adapters/catalog.py`, `test-suite/src/x86decomp_testkit/adapters/detection.py`, `test-suite/src/x86decomp_testkit/adapters/installation.py`, `test-suite/src/x86decomp_testkit/live_adapters.py`, `test-suite/src/x86decomp_testkit/orchestrator.py`
- **Key imports/dependencies:** `__future__`, `dataclasses`, `enum`, `pathlib`, `typing`

## B. Functional Summary

Provide the installed test-suite implementation for the `x86decomp_testkit.models` module. Major symbols: Status, AdapterKind, ProbeResult, AdapterSpec, TestResult, RunSummary, normalized_path, ProbeResult.to_dict, TestResult.to_dict, RunSummary.counts, RunSummary.exit_code, RunSummary.to_dict. No side-effect-relevant call matched the audit scanner’s rule set.
...
Module docstring present: yes. Documented definitions: 12/12. 4 generic low-information docstring pattern hit(s) are enumerated in evidence/generic-docstrings.json and tracked by DOC-001.

Documentation was judged proportionally: public/non-obvious behavior requires specific contracts, while trivial fixtures and data files do not require artificial prose.

## E. Code Quality and Maintainability

Highest structural complexity: RunSummary.exit_code (branches=4, AST nodes=61), RunSummary.to_dict (branches=3, AST nodes=122), RunSummary.counts (branches=2, AST nodes=52), TestResult.to_dict (branches=0, AST nodes=38), normalized_path (branches=0, AST nodes=28).
