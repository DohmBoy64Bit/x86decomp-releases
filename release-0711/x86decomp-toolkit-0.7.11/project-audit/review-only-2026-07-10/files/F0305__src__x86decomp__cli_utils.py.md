...
- **Inventory ID:** `F0305`
- **Relative path:** `src/x86decomp/cli_utils.py`
- **SHA-256:** `00ff8b3bf95c9d90cd01af5a74889c0104b8152d31587cd0db6319e1887569d4`
- **File size:** 4000 bytes
- **Language/format:** Python source
- **Classification:** First-party source code
- **Apparent responsibility:** Shared command-line JSON parsing and output helpers.
- **Provenance:** First-party or repository-maintained text
- **Review applicability:** Complete-content text/source review
- **Related files / static consumers:** `src/x86decomp/assembly/cli.py`, `src/x86decomp/canonical.py`, `src/x86decomp/cli.py`, `src/x86decomp/governance/cli.py`, `src/x86decomp/native/cli.py`, `src/x86decomp/reconstruction/cli.py`, `tests/governance/test_governance_cli_schemas.py`, `tests/native/test_inventory_and_loops.py`
- **Key imports/dependencies:** `__future__`, `json`, `sys`, `typing`, `x86decomp.errors`

## B. Functional Summary

Shared command-line JSON parsing and output helpers. Major symbols: parse_json_arg, emit_json, run_cli. No side-effect-relevant call matched the audit scanner’s rule set.
...
Highest structural complexity: parse_json_arg (branches=2, AST nodes=49), run_cli (branches=1, AST nodes=137), emit_json (branches=1, AST nodes=40).
...
Static search found direct symbol references in tests: emit_json(1), parse_json_arg(10), run_cli(1). The exact 258-test inventory passed; this is evidence of use, not a line-coverage claim.
...
- **Test confidence:** Static search found direct symbol references in tests: emit_json(1), parse_json_arg(10), run_cli(1). The exact 258-test inventory passed; this is evidence of use, not a line-coverage claim.
