# Per-file audit: `test-suite/schemas/feature-catalog.schema.json`

## A. File Identity

- **Inventory ID:** `F0448`
- **Relative path:** `test-suite/schemas/feature-catalog.schema.json`
- **SHA-256:** `d6bc10903a5a2760c669b9fc5b1cec7990a0118de30318c2727f3934afe00daa`
- **File size:** 3653 bytes
- **Language/format:** JSON
- **Classification:** Schema or contract
- **Apparent responsibility:** Structured repository data with top-level keys: $id, $schema, title, type, additionalProperties, required, properties.
...
Structured repository data with top-level keys: $id, $schema, title, type, additionalProperties, required, properties. JSON parsing was verified; top-level type is dict.
