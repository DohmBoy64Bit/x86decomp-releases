# Per-file audit: `test-suite/examples/x86decomp-test.json`

## A. File Identity

- **Inventory ID:** `F0446`
- **Relative path:** `test-suite/examples/x86decomp-test.json`
- **SHA-256:** `5cd31838533f866853e0730aa63ed36958b4d1dc92f8cfb3d5825da9c9d4204d`
- **File size:** 470 bytes
- **Language/format:** JSON
- **Classification:** Test fixture/data
- **Apparent responsibility:** Structured repository data with top-level keys: schema_version, toolkit_root, output_root, adapter_paths, install_root, python_executable, strict, interactive.
...
Structured repository data with top-level keys: schema_version, toolkit_root, output_root, adapter_paths, install_root, python_executable, strict, interactive. JSON parsing was verified; top-level type is dict.
