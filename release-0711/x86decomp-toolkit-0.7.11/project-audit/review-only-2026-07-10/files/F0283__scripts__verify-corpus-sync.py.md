# Per-file audit: `scripts/verify-corpus-sync.py`

## A. File Identity

- **Inventory ID:** `F0283`
- **Relative path:** `scripts/verify-corpus-sync.py`
- **SHA-256:** `2d6641a25618c40cd374a38c2b9b83f8b8269371f7fe5d9b609615e075038afc`
...
- **Key imports/dependencies:** `__future__`, `hashlib`, `json`, `pathlib`

## B. Functional Summary

Repository python source asset. Major symbols: inventory, main. No side-effect-relevant call matched the audit scanner’s rule set.
...
Highest structural complexity: main (branches=2, AST nodes=160), inventory (branches=1, AST nodes=59).
