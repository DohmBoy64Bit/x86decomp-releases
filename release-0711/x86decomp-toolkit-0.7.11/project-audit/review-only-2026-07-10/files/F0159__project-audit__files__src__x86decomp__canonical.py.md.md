# Per-file audit: `project-audit/files/src__x86decomp__canonical.py.md`

## A. File Identity

- **Inventory ID:** `F0159`
- **Relative path:** `project-audit/files/src__x86decomp__canonical.py.md`
- **SHA-256:** `da367ed0d4e843de0a21ecdd4cb7d23d6ffd6fc17c5e7b93a08349e9e801a0e4`
...
Historical human-readable audit evidence or per-file review. Principal sections: Per-file audit — src/x86decomp/canonical.py; A. Identity; B. Function (read fully, 317 lines); C. Correctness; D. Documentation; L. Findings; M. Verdict.
