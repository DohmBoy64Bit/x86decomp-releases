# Per-file audit: `docs/local-llm.md`

## A. File Identity

- **Inventory ID:** `F0060`
- **Relative path:** `docs/local-llm.md`
- **SHA-256:** `d130229c46928ac6a42c5b82610d3c50208676ec31d5c1199bd8bf9dffb68533`
- **File size:** 9122 bytes
- **Language/format:** Markdown
- **Classification:** Documentation
- **Apparent responsibility:** Documentation centered on 'Local LLM C generation and exact byte matching'.
...
Documentation centered on 'Local LLM C generation and exact byte matching'. Principal sections: Local LLM C generation and exact byte matching; Supported provider profiles; Canonical routes; Job contract; Prompt contract; One-shot proposal; Closed exact-match loop; Acceptance gate.
...
12 line(s) exceed 140 characters; this is a maintainability signal, not by itself a defect.
