# Per-file audit: `docs/evidence-and-claims.md`

## A. File Identity

- **Inventory ID:** `F0056`
- **Relative path:** `docs/evidence-and-claims.md`
- **SHA-256:** `a573ac934a840cec2976052600e8631ce736442ac86650cce2116d0011a28f16`
- **File size:** 2188 bytes
- **Language/format:** Markdown
- **Classification:** Documentation
- **Apparent responsibility:** Documentation centered on 'Evidence and claims'.
...
Documentation centered on 'Evidence and claims'. Principal sections: Evidence and claims; Why claims are separate from observations; Evidence kinds; Verification gate; Examples; Calling convention; Original function name; Structure layout.
