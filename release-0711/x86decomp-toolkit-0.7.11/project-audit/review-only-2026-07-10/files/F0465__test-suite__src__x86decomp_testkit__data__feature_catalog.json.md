# Per-file audit: `test-suite/src/x86decomp_testkit/data/feature_catalog.json`

## A. File Identity

- **Inventory ID:** `F0465`
- **Relative path:** `test-suite/src/x86decomp_testkit/data/feature_catalog.json`
- **SHA-256:** `8b12c1c8ca690e8fbed68af99d92304d0c2c1298442434403e766c5660bff2c7`
- **File size:** 104504 bytes
- **Language/format:** JSON
- **Classification:** First-party verification-harness source
- **Apparent responsibility:** Structured repository data with top-level keys: adapters, all_function_symbols, canonical_groups, canonical_routes, cli_commands, coverage_contract, entry_points, ghidra_scripts.
...
Structured repository data with top-level keys: adapters, all_function_symbols, canonical_groups, canonical_routes, cli_commands, coverage_contract, entry_points, ghidra_scripts. JSON parsing was verified; top-level type is dict.
