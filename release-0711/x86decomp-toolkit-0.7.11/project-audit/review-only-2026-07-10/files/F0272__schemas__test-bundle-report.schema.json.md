# Per-file audit: `schemas/test-bundle-report.schema.json`

## A. File Identity

- **Inventory ID:** `F0272`
- **Relative path:** `schemas/test-bundle-report.schema.json`
...
- **Apparent responsibility:** Structured repository data with top-level keys: $schema, $id, title, type, required, properties.
...
Structured repository data with top-level keys: $schema, $id, title, type, required, properties. JSON parsing was verified; top-level type is dict.
