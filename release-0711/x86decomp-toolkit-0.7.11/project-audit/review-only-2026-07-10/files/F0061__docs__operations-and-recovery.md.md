# Per-file audit: `docs/operations-and-recovery.md`

## A. File Identity

- **Inventory ID:** `F0061`
- **Relative path:** `docs/operations-and-recovery.md`
- **SHA-256:** `7430e41f4663a97f752ccc7a8686c1a39693605ea71ad88725c9fa33fe755238`
- **File size:** 4095 bytes
- **Language/format:** Markdown
- **Classification:** Documentation
- **Apparent responsibility:** Documentation centered on 'Operations, resumability, and recovery'.
...
Documentation centered on 'Operations, resumability, and recovery'. Principal sections: Operations, resumability, and recovery; Durable pipeline model; Job states; Cancellation and stale runners; Transactional state; Check, backup, restore, repair, and GC; Worker boundaries; Local bounded worker.
...
11 Markdown heading(s) structure the document; local targets were checked repository-wide.
