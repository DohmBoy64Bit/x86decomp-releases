# Per-file audit: `src/x86decomp/governance/consensus.py`

## A. File Identity

- **Inventory ID:** `F0353`
- **Relative path:** `src/x86decomp/governance/consensus.py`
- **SHA-256:** `26bac1f62bf88a107e8fe46fe45ed2b43c3d26332973f5f41dff76b8fd9edb71`
- **File size:** 7607 bytes
- **Language/format:** Python source
- **Classification:** First-party source code
- **Apparent responsibility:** Provide the current runtime implementation for the `x86decomp.governance.consensus` module.
...
Provide the current runtime implementation for the `x86decomp.governance.consensus` module. Major symbols: ConsensusEngine, ConsensusEngine.record, ConsensusEngine.scan, ConsensusEngine.conflicts, ConsensusEngine.resolve, ConsensusEngine.explain. Static analysis recorded 5 filesystem, process, database, network, or other side-effect-relevant call(s).
...
Highest structural complexity: ConsensusEngine.resolve (branches=7, AST nodes=259), ConsensusEngine.scan (branches=6, AST nodes=514), ConsensusEngine.explain (branches=3, AST nodes=196), ConsensusEngine.record (branches=1, AST nodes=154), ConsensusEngine.conflicts (branches=1, AST nodes=39). 15 line(s) exceed 140 characters; this is a maintainability signal, not by itself a defect.
...
Static search found direct symbol references in tests: ConsensusEngine(8), conflicts(9), explain(9), record(23), resolve(62), scan(15). The exact 258-test inventory passed; this is evidence of use, not a line-coverage claim.
...
- **Test confidence:** Static search found direct symbol references in tests: ConsensusEngine(8), conflicts(9), explain(9), record(23), resolve(62), scan(15). The exact 258-test inventory passed; this is evidence of use, not a line-coverage claim.
