# Per-file audit: `project-audit/files/src__x86decomp__util.py.md`

## A. File Identity

- **Inventory ID:** `F0177`
- **Relative path:** `project-audit/files/src__x86decomp__util.py.md`
- **SHA-256:** `010988af7e03ea5971cd444ec815f0470bd1a863f58d53ce3e9fa483197278bf`
...
Historical human-readable audit evidence or per-file review. Principal sections: Per-file audit — src/x86decomp/util.py; A. Identity; B. Function (read fully, 217 lines); C. Correctness; D. Documentation; K. Duplication — DUP-002 (verified); L. Findings; M. Verdict.
