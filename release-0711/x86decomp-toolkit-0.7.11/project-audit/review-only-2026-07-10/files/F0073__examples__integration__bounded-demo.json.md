# Per-file audit: `examples/integration/bounded-demo.json`

## A. File Identity

- **Inventory ID:** `F0073`
- **Relative path:** `examples/integration/bounded-demo.json`
- **SHA-256:** `e1b589e23a5fa0a7c1310c69760ef7729fa912c2a5584985a7cbb487f57eab26`
- **File size:** 891 bytes
- **Language/format:** JSON
- **Classification:** Example or sample
- **Apparent responsibility:** Structured repository data with top-level keys: schema_version, name, captured_output_limit, execution, scenarios.
...
Structured repository data with top-level keys: schema_version, name, captured_output_limit, execution, scenarios. JSON parsing was verified; top-level type is dict.
