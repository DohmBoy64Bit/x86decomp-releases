...
- **Apparent responsibility:** Documentation centered on 'Agent and contributor operating rules — 0.7.11'.
...
Documentation centered on 'Agent and contributor operating rules — 0.7.11'. Principal sections: Agent and contributor operating rules — 0.7.11; Release model; Non-negotiable engineering rules; Required release gates; Evidence vocabulary.
