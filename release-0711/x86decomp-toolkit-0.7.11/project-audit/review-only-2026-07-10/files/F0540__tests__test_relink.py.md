# Per-file audit: `tests/test_relink.py`

## A. File Identity

- **Inventory ID:** `F0540`
- **Relative path:** `tests/test_relink.py`
- **SHA-256:** `1d4a4b9959fa574e52245cfb9c18921d48fbd3334c414b1d248143f014eb6ef6`
...
- **Key imports/dependencies:** `__future__`, `json`, `pathlib`, `pytest`, `shutil`, `x86decomp.coff`, `x86decomp.relink`

## B. Functional Summary

Executable regression tests for the behavior indicated by the filename and test symbols. Major symbols: test_manifest_driven_full_relink. Static analysis recorded 1 filesystem, process, database, network, or other side-effect-relevant call(s).
...
Python parsed successfully with the standard-library AST parser. Side-effect/trust-sensitive calls reviewed: manifest.write_text×1.
...
Highest structural complexity: test_manifest_driven_full_relink (branches=0, AST nodes=123).
