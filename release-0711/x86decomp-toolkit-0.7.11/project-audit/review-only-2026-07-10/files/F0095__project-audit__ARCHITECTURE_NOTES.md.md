# Per-file audit: `project-audit/ARCHITECTURE_NOTES.md`

## A. File Identity

- **Inventory ID:** `F0095`
- **Relative path:** `project-audit/ARCHITECTURE_NOTES.md`
- **SHA-256:** `c01219e56beda194ab507dd954aaab6c0edb78df085f941538c8da9b68288a81`
...
Historical human-readable audit evidence or per-file review. Principal sections: Architecture Notes — x86decomp-toolkit 0.7.11; Entry points (Verified); Command registration and dispatch (Verified for cli.py; canonical.py pending); Module structure (src/x86decomp, 117 modules, ~31k LOC) (Verified listing; roles Probable); Data flow (Probable, from CLI signatures); Trust boundaries (Probable — key audit surfaces); Configuration flow (Probable); Test organization (Verified counts).
...
18 line(s) exceed 140 characters; this is a maintainability signal, not by itself a defect.
