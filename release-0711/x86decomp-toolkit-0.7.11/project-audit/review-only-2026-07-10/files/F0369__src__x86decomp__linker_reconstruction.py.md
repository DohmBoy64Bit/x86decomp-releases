# Per-file audit: `src/x86decomp/linker_reconstruction.py`

## A. File Identity

- **Inventory ID:** `F0369`
- **Relative path:** `src/x86decomp/linker_reconstruction.py`
- **SHA-256:** `5af77b480cf94aa7f825f507ad4b0ff3a0c5ed3988d3f4a9515fef1910419eae`
- **File size:** 6722 bytes
- **Language/format:** Python source
- **Classification:** First-party source code
- **Apparent responsibility:** Evidence-driven linker reconstruction plans.
- **Provenance:** First-party or repository-maintained text
- **Review applicability:** Complete-content text/source review
- **Related files / static consumers:** `src/x86decomp/cli.py`, `tests/test_production.py`
- **Key imports/dependencies:** `.coff`, `.coff_archive`, `.errors`, `.linker_layout`, `.pe`, `.util`, `__future__`, `pathlib`, `typing`

## B. Functional Summary

Evidence-driven linker reconstruction plans. Major symbols: build_linker_reconstruction_plan, write_relink_manifest_from_plan. No side-effect-relevant call matched the audit scanner’s rule set.
...
Highest structural complexity: build_linker_reconstruction_plan (branches=26, AST nodes=886), write_relink_manifest_from_plan (branches=2, AST nodes=78).
...
Static search found direct symbol references in tests: build_linker_reconstruction_plan(3), write_relink_manifest_from_plan(3). The exact 258-test inventory passed; this is evidence of use, not a line-coverage claim.
...
- **Test confidence:** Static search found direct symbol references in tests: build_linker_reconstruction_plan(3), write_relink_manifest_from_plan(3). The exact 258-test inventory passed; this is evidence of use, not a line-coverage claim.
