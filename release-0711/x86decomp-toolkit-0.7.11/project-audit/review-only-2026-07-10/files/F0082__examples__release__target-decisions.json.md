# Per-file audit: `examples/release/target-decisions.json`

## A. File Identity

- **Inventory ID:** `F0082`
- **Relative path:** `examples/release/target-decisions.json`
- **SHA-256:** `91b5bfcd613ac3d76fc020e5bb415d0ae11594886c6cac4317cc06e7ea5df1cb`
- **File size:** 351 bytes
- **Language/format:** JSON
- **Classification:** Example or sample
- **Apparent responsibility:** Structured repository data with top-level keys: preferred_mode, compiler_family, compiler_version, linker_family, source_language, allow_host_execution, target_description.
...
Structured repository data with top-level keys: preferred_mode, compiler_family, compiler_version, linker_family, source_language, allow_host_execution, target_description. JSON parsing was verified; top-level type is dict.
