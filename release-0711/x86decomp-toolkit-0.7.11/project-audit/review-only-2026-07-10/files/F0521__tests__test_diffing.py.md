# Per-file audit: `tests/test_diffing.py`

## A. File Identity

- **Inventory ID:** `F0521`
- **Relative path:** `tests/test_diffing.py`
- **SHA-256:** `79ad9b5274ca2a57d0fb580b12dc6c4ff4c56cfedfd66819d016ceb8bd0bc7b1`
- **File size:** 974 bytes
...
- **Key imports/dependencies:** `__future__`, `unittest`, `x86decomp.diffing`

## B. Functional Summary

Executable regression tests for the behavior indicated by the filename and test symbols. Major symbols: DiffingTests, DiffingTests.test_equal, DiffingTests.test_mismatch. No side-effect-relevant call matched the audit scanner’s rule set.
...
Highest structural complexity: DiffingTests.test_equal (branches=0, AST nodes=48), DiffingTests.test_mismatch (branches=0, AST nodes=43).
