# Per-file audit: `mkdocs.yml`

## A. File Identity

- **Inventory ID:** `F0094`
- **Relative path:** `mkdocs.yml`
- **SHA-256:** `3bedb6a276d9887122152f036f4ac38c6df55bbdde44edbe340f58233ecda9a0`
- **File size:** 920 bytes
- **Language/format:** YAML
- **Classification:** Configuration or packaging
- **Apparent responsibility:** Repository yaml asset.
