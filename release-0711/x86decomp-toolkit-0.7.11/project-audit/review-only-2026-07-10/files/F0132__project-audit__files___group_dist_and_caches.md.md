# Per-file audit: `project-audit/files/_group_dist_and_caches.md`

## A. File Identity

- **Inventory ID:** `F0132`
- **Relative path:** `project-audit/files/_group_dist_and_caches.md`
- **SHA-256:** `771551f8762b0922bfb5796624dce657b17e63c0cda80e63e21269ce54e886d7`
...
Historical human-readable audit evidence or per-file review. Principal sections: Grouped audit — generated artifacts and caches (B02g); dist/x86decomp_toolkit-0.7.11-py3-none-any.whl (369,957 B, binary zip); dist/x86decomp_toolkit-0.7.11.tar.gz (529,267 B, binary archive); .pytest_cache/ (5 files: .gitignore, CACHEDIR.TAG, README.md, v/cache/lastfailed, v/cache/nodeids); Verdict.
