# Per-file audit: `docs/project-memory.md`

## A. File Identity

- **Inventory ID:** `F0062`
- **Relative path:** `docs/project-memory.md`
- **SHA-256:** `9053e590e5f0394ff3d07534b017e51b593f5d71d225d2b6e71d70dfd51284ea`
- **File size:** 1179 bytes
- **Language/format:** Markdown
- **Classification:** Documentation
- **Apparent responsibility:** Documentation centered on 'Project-memory protocol'.
...
Documentation centered on 'Project-memory protocol'. Principal sections: Project-memory protocol; Ledger; What belongs in memory; What does not belong in memory; Rendering.
