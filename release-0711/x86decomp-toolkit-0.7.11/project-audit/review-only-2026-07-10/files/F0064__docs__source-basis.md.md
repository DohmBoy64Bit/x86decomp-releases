# Per-file audit: `docs/source-basis.md`

## A. File Identity

- **Inventory ID:** `F0064`
- **Relative path:** `docs/source-basis.md`
- **SHA-256:** `b0950b1b47308b283028c141a84c8cbf41f377d68b269d418c239edd7e8e9ee4`
- **File size:** 1097 bytes
- **Language/format:** Markdown
- **Classification:** Documentation
- **Apparent responsibility:** Documentation centered on 'Source basis and upstream boundaries'.
...
Documentation centered on 'Source basis and upstream boundaries'. Principal sections: Source basis and upstream boundaries.
