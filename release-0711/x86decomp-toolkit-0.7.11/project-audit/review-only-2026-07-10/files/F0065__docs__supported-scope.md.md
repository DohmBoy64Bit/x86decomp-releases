# Per-file audit: `docs/supported-scope.md`

## A. File Identity

- **Inventory ID:** `F0065`
- **Relative path:** `docs/supported-scope.md`
- **SHA-256:** `da10c7f01980d8393fcd41223feb4ec6a7c2f8fdb259f56336b4c5c384848ca4`
- **File size:** 537 bytes
- **Language/format:** Markdown
- **Classification:** Documentation
- **Apparent responsibility:** Documentation centered on 'Supported scope — 0.7.11'.
...
Documentation centered on 'Supported scope — 0.7.11'. Principal sections: Supported scope — 0.7.11.
