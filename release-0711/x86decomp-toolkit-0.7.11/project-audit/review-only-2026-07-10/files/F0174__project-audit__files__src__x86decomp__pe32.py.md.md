# Per-file audit: `project-audit/files/src__x86decomp__pe32.py.md`

## A. File Identity

- **Inventory ID:** `F0174`
- **Relative path:** `project-audit/files/src__x86decomp__pe32.py.md`
- **SHA-256:** `527707aec58f4a490e2050dd4f468caa09001b9ada435925b691d136a9353e80`
...
Historical human-readable audit evidence or per-file review. Principal sections: Per-file audit — src/x86decomp/pe32.py; A. Identity; B. Function (read fully, 1,144 lines); C. Correctness — hardened (Verified); D/E. Docs/Maintainability; H. Security; L. Findings; M. Verdict.
