# Per-file audit: `project-audit/files/src__x86decomp__errors.py.md`

## A. File Identity

- **Inventory ID:** `F0166`
- **Relative path:** `project-audit/files/src__x86decomp__errors.py.md`
- **SHA-256:** `513a917957c0eff56fbf96904de287a95680124f5d33286f1f4cd1c3aa83de08`
...
Historical human-readable audit evidence or per-file review. Principal sections: Per-file audit — src/x86decomp/errors.py; A. Identity; B. Function (read fully, 21 lines); C. Correctness — ARC-001; L. Findings; M. Verdict.
