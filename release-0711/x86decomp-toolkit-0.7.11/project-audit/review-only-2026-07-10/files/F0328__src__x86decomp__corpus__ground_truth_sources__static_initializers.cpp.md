# Per-file audit: `src/x86decomp/corpus/ground_truth_sources/static_initializers.cpp`

## A. File Identity

- **Inventory ID:** `F0328`
- **Relative path:** `src/x86decomp/corpus/ground_truth_sources/static_initializers.cpp`
- **SHA-256:** `5566d58941846d63fafa6e6047f5f0a70dd19ff484aea58f1eac88cfa1c3156c`
- **File size:** 143 bytes
