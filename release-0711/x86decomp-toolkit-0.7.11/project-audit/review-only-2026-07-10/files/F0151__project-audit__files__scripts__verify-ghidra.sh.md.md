# Per-file audit: `project-audit/files/scripts__verify-ghidra.sh.md`

## A. File Identity

- **Inventory ID:** `F0151`
- **Relative path:** `project-audit/files/scripts__verify-ghidra.sh.md`
- **SHA-256:** `2c72510a8ceefaecc8f901601a80dc73de41bfb517d430279ec6c9cbbe68d3ae`
...
Historical human-readable audit evidence or per-file review. Principal sections: Per-file audit — scripts/verify-ghidra.sh; A. Identity; B. Function (read fully); H. Security; M. Verdict.
