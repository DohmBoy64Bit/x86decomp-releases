# Per-file audit: `tests/test_mcp.py`

## A. File Identity

- **Inventory ID:** `F0531`
- **Relative path:** `tests/test_mcp.py`
- **SHA-256:** `0ce5504a8eccac6c351e21a9e5c8ba0c7be4da8470faa4a467087d471cb37022`
...
- **Key imports/dependencies:** `__future__`, `pathlib`, `sys`, `x86decomp.mcp`

## B. Functional Summary

Executable regression tests for the behavior indicated by the filename and test symbols. Major symbols: test_stdio_mcp_and_mutation_journal. Static analysis recorded 1 filesystem, process, database, network, or other side-effect-relevant call(s).
...
Highest structural complexity: test_stdio_mcp_and_mutation_journal (branches=2, AST nodes=177), _server (branches=0, AST nodes=17). 1 line(s) exceed 140 characters; this is a maintainability signal, not by itself a defect.
