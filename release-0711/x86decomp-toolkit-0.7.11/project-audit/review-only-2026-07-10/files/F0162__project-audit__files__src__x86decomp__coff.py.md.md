# Per-file audit: `project-audit/files/src__x86decomp__coff.py.md`

## A. File Identity

- **Inventory ID:** `F0162`
- **Relative path:** `project-audit/files/src__x86decomp__coff.py.md`
- **SHA-256:** `0aa7bef1164e4b8743a823d6ff530321e3a7909635d7febffa757e7ebeaebf44`
...
Historical human-readable audit evidence or per-file review. Principal sections: Per-file audit — src/x86decomp/coff.py; A. Identity; B. Function (read fully, 1,394 lines); C. Correctness (Verified); D. Documentation; E. Maintainability; H. Security; L. Findings.
