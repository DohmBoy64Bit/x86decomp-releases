# Per-file audit: `src/x86decomp/native/__init__.py`

## A. File Identity

- **Inventory ID:** `F0379`
- **Relative path:** `src/x86decomp/native/__init__.py`
- **SHA-256:** `c06bf6b79e240a8ec82b7084a6f50358b49e0c28084ed2cece59bd0f803dfb0d`
- **File size:** 158 bytes
- **Language/format:** Python source
- **Classification:** First-party source code
- **Apparent responsibility:** Native PE reconstruction and closed-loop matching capabilities.
...
Native PE reconstruction and closed-loop matching capabilities. It defines no public Python symbols. No side-effect-relevant call matched the audit scanner’s rule set.
