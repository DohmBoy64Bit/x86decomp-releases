# Per-file audit: `project-audit/manifest_failures.txt`

## A. File Identity

- **Inventory ID:** `F0179`
- **Relative path:** `project-audit/manifest_failures.txt`
- **SHA-256:** `c25f533e868c223a875cf34c7dc6328f922f45545b3cf03f937d619c6d669809`
- **File size:** 2982 bytes
- **Language/format:** Plain text
- **Classification:** Historical audit artifact
- **Apparent responsibility:** Historical audit support artifact.
...
Historical audit support artifact.
