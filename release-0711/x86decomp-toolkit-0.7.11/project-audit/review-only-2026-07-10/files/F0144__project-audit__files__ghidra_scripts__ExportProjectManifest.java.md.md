# Per-file audit: `project-audit/files/ghidra_scripts__ExportProjectManifest.java.md`

## A. File Identity

- **Inventory ID:** `F0144`
- **Relative path:** `project-audit/files/ghidra_scripts__ExportProjectManifest.java.md`
- **SHA-256:** `3622124095072096219637c9b30bc7096bf99c9cb2f35d7992dd613ffc2829ed`
- **File size:** 672 bytes
...
Historical human-readable audit evidence or per-file review. Principal sections: Per-file audit — ghidra_scripts/ExportProjectManifest.java; A. Identity; B. Function (read fully, 307 lines); M. Verdict.
