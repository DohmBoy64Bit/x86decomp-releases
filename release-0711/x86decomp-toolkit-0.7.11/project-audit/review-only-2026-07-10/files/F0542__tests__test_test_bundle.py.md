# Per-file audit: `tests/test_test_bundle.py`

## A. File Identity

- **Inventory ID:** `F0542`
- **Relative path:** `tests/test_test_bundle.py`
- **SHA-256:** `0a4438720e3b88d741ab30a69a57104e3a3e41de0ef903c0f4f376dcbd538ed5`
...
- **Key imports/dependencies:** `__future__`, `json`, `pathlib`, `pe_fixture`, `pytest`, `x86decomp.errors`, `x86decomp.test_bundle`, `x86decomp.util`, `zipfile`

## B. Functional Summary

Executable regression tests for the behavior indicated by the filename and test symbols. Major symbols: test_static_test_bundle_inspection, test_test_bundle_hash_is_enforced, test_test_bundle_rejects_path_traversal, test_test_bundle_requires_authorization, test_create_test_bundle_round_trip. No side-effect-relevant call matched the audit scanner’s rule set.
...
Highest structural complexity: _bundle (branches=0, AST nodes=115), test_test_bundle_requires_authorization (branches=0, AST nodes=100), test_test_bundle_rejects_path_traversal (branches=0, AST nodes=96), test_create_test_bundle_round_trip (branches=0, AST nodes=83), test_static_test_bundle_inspection (branches=0, AST nodes=78).
