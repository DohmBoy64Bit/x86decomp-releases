# Per-file audit: `src/x86decomp/corpus/ground_truth_sources/exceptions.cpp`

## A. File Identity

- **Inventory ID:** `F0321`
- **Relative path:** `src/x86decomp/corpus/ground_truth_sources/exceptions.cpp`
- **SHA-256:** `fd15c6bd23f39262a9aa02f94f02210dacab53a2a5d358aae415bba2c329394e`
- **File size:** 156 bytes
