# Per-file audit: `examples/integration/candidate_mismatch.py`

## A. File Identity

- **Inventory ID:** `F0075`
- **Relative path:** `examples/integration/candidate_mismatch.py`
- **SHA-256:** `108e2316477fc03c410ec8ca790b035729fcdc2199f8ec5cd0ca749e09e21347`
- **File size:** 224 bytes
...
Repository python source asset. Major symbols: add. No side-effect-relevant call matched the audit scanner’s rule set.
...
Highest structural complexity: add (branches=0, AST nodes=19).
