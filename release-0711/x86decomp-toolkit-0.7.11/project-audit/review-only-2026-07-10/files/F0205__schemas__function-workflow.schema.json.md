# Per-file audit: `schemas/function-workflow.schema.json`

## A. File Identity

- **Inventory ID:** `F0205`
- **Relative path:** `schemas/function-workflow.schema.json`
...
- **Apparent responsibility:** Structured repository data with top-level keys: $schema, $id, title, type, additionalProperties, required, properties.
...
Structured repository data with top-level keys: $schema, $id, title, type, additionalProperties, required, properties. JSON parsing was verified; top-level type is dict.
