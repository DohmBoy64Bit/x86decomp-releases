# Per-file audit: `schemas/reconstruction/compatibility-shim.schema.json`

## A. File Identity

- **Inventory ID:** `F0253`
- **Relative path:** `schemas/reconstruction/compatibility-shim.schema.json`
...
- **Apparent responsibility:** Structured repository data with top-level keys: $id, $schema, additionalProperties, properties, required, title, type.
...
Structured repository data with top-level keys: $id, $schema, additionalProperties, properties, required, title, type. JSON parsing was verified; top-level type is dict.
