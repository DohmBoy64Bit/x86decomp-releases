# Per-file audit: `tests/test_documentation.py`

## A. File Identity

- **Inventory ID:** `F0523`
- **Relative path:** `tests/test_documentation.py`
- **SHA-256:** `1ad36a9753c326fb264cb0fbb286ea72d7c02303e46ca21c67cf61116228b954`
- **File size:** 2574 bytes
...
- **Key imports/dependencies:** `__future__`, `json`, `pathlib`

## B. Functional Summary

Executable regression tests for the behavior indicated by the filename and test symbols. Major symbols: test_release_documents_and_maps_are_current, test_test_plan_counts_match_feature_catalog, test_four_architecture_artifacts_exist_and_cross_link. No side-effect-relevant call matched the audit scanner’s rule set.
...
Highest structural complexity: test_test_plan_counts_match_feature_catalog (branches=1, AST nodes=136), test_release_documents_and_maps_are_current (branches=1, AST nodes=98), test_four_architecture_artifacts_exist_and_cross_link (branches=1, AST nodes=89).
