# Per-file audit: `test-suite/docs/ARCHITECTURE_MAP.md`

## A. File Identity

- **Inventory ID:** `F0441`
- **Relative path:** `test-suite/docs/ARCHITECTURE_MAP.md`
- **SHA-256:** `80a50857c0d0d0da0f36a55b9f6f890dfc48d5207fe1d5d8401f46e2a15741d5`
- **File size:** 1958 bytes
- **Language/format:** Markdown
- **Classification:** Documentation
- **Apparent responsibility:** Documentation centered on 'Test-suite architecture map — 0.7.11'.
...
Documentation centered on 'Test-suite architecture map — 0.7.11'. Principal sections: Test-suite architecture map — 0.7.11; v0.7.11 acceleration verification overlay.
