# Per-file audit: `tests/test_evidence.py`

## A. File Identity

- **Inventory ID:** `F0526`
- **Relative path:** `tests/test_evidence.py`
- **SHA-256:** `e9ee9b21a1f4fe7838a91f2a5cca7573f862e9b7f3d52d980b423d93101db782`
...
- **Key imports/dependencies:** `__future__`, `pathlib`, `tempfile`, `unittest`, `x86decomp.evidence`, `x86decomp.models`

## B. Functional Summary

Executable regression tests for the behavior indicated by the filename and test symbols. Major symbols: EvidenceTests, EvidenceTests.test_three_independent_sources_verify_claim, EvidenceTests.test_same_group_does_not_verify. Static analysis recorded 1 filesystem, process, database, network, or other side-effect-relevant call(s).
...
Python parsed successfully with the standard-library AST parser. Side-effect/trust-sensitive calls reviewed: path.write_bytes×1.
...
Highest structural complexity: EvidenceTests.test_three_independent_sources_verify_claim (branches=2, AST nodes=205), EvidenceTests.test_same_group_does_not_verify (branches=1, AST nodes=143).
