# Per-file audit: `project-audit/files/scripts__run-pytest-partitions.py.md`

## A. File Identity

- **Inventory ID:** `F0147`
- **Relative path:** `project-audit/files/scripts__run-pytest-partitions.py.md`
- **SHA-256:** `f23b9c643f6512c31fe603ba65558c110f815c38d47902461195fc89be5ba913`
- **File size:** 874 bytes
...
Historical human-readable audit evidence or per-file review. Principal sections: Per-file audit — scripts/run-pytest-partitions.py; A. Identity; B. Function (read fully, 162 lines); C. Correctness; M. Verdict.
