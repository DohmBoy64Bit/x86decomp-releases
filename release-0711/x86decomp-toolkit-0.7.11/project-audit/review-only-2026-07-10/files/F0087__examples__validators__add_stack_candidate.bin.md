# Per-file audit: `examples/validators/add_stack_candidate.bin`

## A. File Identity

- **Inventory ID:** `F0087`
- **Relative path:** `examples/validators/add_stack_candidate.bin`
- **SHA-256:** `6d1e1d30f2068501de61e0022c4352fda2a7650f29eb96f01ad04fa160305e21`
- **File size:** 9 bytes
- **Language/format:** Binary fixture
- **Classification:** Example or sample
- **Apparent responsibility:** Opaque binary fixture used by parser tests.
- **Provenance:** Repository binary fixture; provenance not independently established
- **Review applicability:** Complete byte/hash inventory plus limited binary-purpose review
...
Opaque binary fixture used by parser tests. Full source-level interpretation is not applicable; the audit recorded the complete bytes, hash, size, and repository context.
...
The fixture was not executed. Its complete bytes and hash were recorded; source-level safety analysis is not applicable.
...
- **Final audit status:** **Audited — limited binary review**
