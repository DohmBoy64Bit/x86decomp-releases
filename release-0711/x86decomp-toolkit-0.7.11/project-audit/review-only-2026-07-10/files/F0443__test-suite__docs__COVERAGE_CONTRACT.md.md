# Per-file audit: `test-suite/docs/COVERAGE_CONTRACT.md`

## A. File Identity

- **Inventory ID:** `F0443`
- **Relative path:** `test-suite/docs/COVERAGE_CONTRACT.md`
- **SHA-256:** `ec9f63965b35fe1a00d5d5f94d77eab6dad6cc10a7c0fc794672dfcaeb58679e`
- **File size:** 1996 bytes
- **Language/format:** Markdown
- **Classification:** Documentation
- **Apparent responsibility:** Documentation centered on 'Coverage and completeness contract'.
...
Documentation centered on 'Coverage and completeness contract'. Principal sections: Coverage and completeness contract; Exact source-surface inventory; Function-body execution; CLI coverage; No-skip and blocked-adapter policy; Thresholds; Structural and operational contracts.
