# Per-file audit: `examples/benchmarks/bounded-demo.json`

## A. File Identity

- **Inventory ID:** `F0069`
- **Relative path:** `examples/benchmarks/bounded-demo.json`
- **SHA-256:** `980ad9dc8352019f4dca1f06e25a8654ec87248befc178c35490ecc3d129a51a`
- **File size:** 1153 bytes
- **Language/format:** JSON
- **Classification:** Example or sample
- **Apparent responsibility:** Structured repository data with top-level keys: schema_version, name, cases.
...
Structured repository data with top-level keys: schema_version, name, cases. JSON parsing was verified; top-level type is dict.
