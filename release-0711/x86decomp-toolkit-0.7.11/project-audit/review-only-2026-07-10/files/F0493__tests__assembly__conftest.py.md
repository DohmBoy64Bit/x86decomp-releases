# Per-file audit: `tests/assembly/conftest.py`

## A. File Identity

- **Inventory ID:** `F0493`
- **Relative path:** `tests/assembly/conftest.py`
- **SHA-256:** `f11e34a5e847aefbc29f1f353e27f8ec3c78e541e579caaa08f3a7fe89954bd7`
- **File size:** 279 bytes
...
- **Key imports/dependencies:** `__future__`, `pathlib`, `sys`

## B. Functional Summary

Executable regression tests for the behavior indicated by the filename and test symbols. It defines no public Python symbols. No side-effect-relevant call matched the audit scanner’s rule set.
