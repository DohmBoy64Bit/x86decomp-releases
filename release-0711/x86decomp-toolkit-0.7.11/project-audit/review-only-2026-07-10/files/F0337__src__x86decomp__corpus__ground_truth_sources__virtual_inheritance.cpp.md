# Per-file audit: `src/x86decomp/corpus/ground_truth_sources/virtual_inheritance.cpp`

## A. File Identity

- **Inventory ID:** `F0337`
- **Relative path:** `src/x86decomp/corpus/ground_truth_sources/virtual_inheritance.cpp`
- **SHA-256:** `c8e83579cd4d6159e716c23270110d997349e3b1a609bf1d50c0b93a2e64d1d2`
- **File size:** 441 bytes
