# Per-file audit: `project-audit/AUDIT_PLAN.md`

## A. File Identity

- **Inventory ID:** `F0097`
- **Relative path:** `project-audit/AUDIT_PLAN.md`
- **SHA-256:** `b44069d3ad020033fbe4fa43a3a165a21c3ff2e9e3df7740356ec6d4136d3ba5`
- **File size:** 5358 bytes
...
Historical human-readable audit evidence or per-file review. Principal sections: Audit Plan — x86decomp-toolkit 0.7.11; Scope; Repository-specific risks to watch; Review order (dependency-ordered batches); Methodology; Commands: safe vs prohibited; Completion criteria.
