# Per-file audit: `project-audit/files/_group_src_governance.md`

## A. File Identity

- **Inventory ID:** `F0138`
- **Relative path:** `project-audit/files/_group_src_governance.md`
- **SHA-256:** `43657313ee772c66b461a7b3fac35f301d8042a60d16694840346f13404f9fc4`
...
Historical human-readable audit evidence or per-file review. Principal sections: Grouped audit — governance/ subsystem (15 files) (B06g-gov).
