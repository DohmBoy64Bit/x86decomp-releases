# Per-file audit: `src/x86decomp/corpus/ground_truth_sources/varargs.c`

## A. File Identity

- **Inventory ID:** `F0335`
- **Relative path:** `src/x86decomp/corpus/ground_truth_sources/varargs.c`
- **SHA-256:** `3326edfa00e59cd41f5409c8ef01d1d5b96c0e1a13471972a2a107725032cdbb`
- **File size:** 244 bytes
