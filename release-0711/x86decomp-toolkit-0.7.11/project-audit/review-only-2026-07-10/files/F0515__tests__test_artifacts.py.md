# Per-file audit: `tests/test_artifacts.py`

## A. File Identity

- **Inventory ID:** `F0515`
- **Relative path:** `tests/test_artifacts.py`
- **SHA-256:** `0fbdc16531b6bedb1d66433b2b7ede06380eb4c6161b89bdf77eaa18f0e1da85`
...
- **Key imports/dependencies:** `__future__`, `json`, `pathlib`, `tempfile`, `unittest`, `x86decomp.artifacts`

## B. Functional Summary

Executable regression tests for the behavior indicated by the filename and test symbols. Major symbols: ArtifactTests, ArtifactTests.test_import_and_verify, ArtifactTests.test_integrity_path_escape_is_rejected. Static analysis recorded 1 filesystem, process, database, network, or other side-effect-relevant call(s).
...
Python parsed successfully with the standard-library AST parser. Side-effect/trust-sensitive calls reviewed: integrity_path.write_text×1.
...
Highest structural complexity: ArtifactTests.test_integrity_path_escape_is_rejected (branches=1, AST nodes=140), ArtifactTests._export (branches=0, AST nodes=78), ArtifactTests.test_import_and_verify (branches=0, AST nodes=65).
