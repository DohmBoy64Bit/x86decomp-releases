# Per-file audit: `project-audit/FILE_INVENTORY.csv`

## A. File Identity

- **Inventory ID:** `F0105`
- **Relative path:** `project-audit/FILE_INVENTORY.csv`
- **SHA-256:** `2a29a2a9aeef5939e42d9ba02b9fb85ba8f0c040c34b87eca49b7ac62fb7cf1e`
- **File size:** 183512 bytes
- **Language/format:** CSV
- **Classification:** Historical audit artifact
- **Apparent responsibility:** Historical audit inventory or ledger data.
...
Historical audit inventory or ledger data.
...
698 line(s) exceed 140 characters; this is a maintainability signal, not by itself a defect.
