# Per-file audit: `tests/test_project.py`

## A. File Identity

- **Inventory ID:** `F0538`
- **Relative path:** `tests/test_project.py`
- **SHA-256:** `db3f4c34e32a704a11739166ebb238e8eafefb25a86bacea69529418929de878`
...
- **Key imports/dependencies:** `__future__`, `pathlib`, `pe_fixture`, `tempfile`, `unittest`, `x86decomp.project`

## B. Functional Summary

Executable regression tests for the behavior indicated by the filename and test symbols. Major symbols: ProjectTests, ProjectTests.test_initialize_and_verify, ProjectTests.test_detect_binary_tampering. Static analysis recorded 1 filesystem, process, database, network, or other side-effect-relevant call(s).
...
Python parsed successfully with the standard-library AST parser. Side-effect/trust-sensitive calls reviewed: stored.write_bytes×1.
...
Highest structural complexity: ProjectTests.test_detect_binary_tampering (branches=1, AST nodes=117), ProjectTests.test_initialize_and_verify (branches=0, AST nodes=122).
