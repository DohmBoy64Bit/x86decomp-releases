# Per-file audit: `project-audit/files/src__x86decomp__test_bundle.py.md`

## A. File Identity

- **Inventory ID:** `F0176`
- **Relative path:** `project-audit/files/src__x86decomp__test_bundle.py.md`
- **SHA-256:** `cabc490e43ff0a57ef873ffecd73665d3881355086a48b758b35f8ce17af7cc1`
...
Historical human-readable audit evidence or per-file review. Principal sections: Per-file audit — src/x86decomp/test_bundle.py; A. Identity; B. Function (read fully, ~300 lines); C/H. Security — model zip handling; M. Verdict.
