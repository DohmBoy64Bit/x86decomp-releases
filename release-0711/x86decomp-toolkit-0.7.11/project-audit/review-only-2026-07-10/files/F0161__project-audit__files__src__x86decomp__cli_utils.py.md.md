# Per-file audit: `project-audit/files/src__x86decomp__cli_utils.py.md`

## A. File Identity

- **Inventory ID:** `F0161`
- **Relative path:** `project-audit/files/src__x86decomp__cli_utils.py.md`
- **SHA-256:** `6083b497cc20fcd7dfa0878b9e920d0839d75339d685e54249eb5ab377f5f7fd`
...
Historical human-readable audit evidence or per-file review. Principal sections: Per-file audit — src/x86decomp/cli_utils.py; A. Identity; B. Function (read fully, 108 lines); C. Correctness — CLI-001 (verified); D. Documentation; L. Findings; M. Verdict.
