...
- **Inventory ID:** `F0289`
- **Relative path:** `src/x86decomp/__main__.py`
- **SHA-256:** `e2e7e903f6057863b3324d6cffe0b7239eec48fa3c4e41f2c436f2b6f5dc7c0f`
- **File size:** 134 bytes
- **Language/format:** Python source
- **Classification:** First-party source code
- **Apparent responsibility:** Module entry point for ``python -m x86decomp``.
...
- **Key imports/dependencies:** `.cli`

## B. Functional Summary

Module entry point for ``python -m x86decomp``. It defines no public Python symbols. No side-effect-relevant call matched the audit scanner’s rule set.
...
Static test search found 15 module-name reference(s). The exact 258-test inventory passed; no per-file line coverage was measured in this audit.
...
- **Test confidence:** Static test search found 15 module-name reference(s). The exact 258-test inventory passed; no per-file line coverage was measured in this audit.
