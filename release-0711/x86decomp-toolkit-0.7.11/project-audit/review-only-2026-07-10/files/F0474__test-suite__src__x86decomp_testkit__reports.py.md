# Per-file audit: `test-suite/src/x86decomp_testkit/reports.py`

## A. File Identity

- **Inventory ID:** `F0474`
- **Relative path:** `test-suite/src/x86decomp_testkit/reports.py`
- **SHA-256:** `f1796aa89169b2077716f344265c9b0ff4dd29c85272a264a55f7a83b2af4d7d`
- **File size:** 6932 bytes
- **Language/format:** Python source
- **Classification:** First-party verification-harness source
- **Apparent responsibility:** Provide the installed test-suite implementation for the `x86decomp_testkit.reports` module.
- **Provenance:** First-party or repository-maintained text
- **Review applicability:** Complete-content text/source review
- **Related files / static consumers:** `test-suite/src/x86decomp_testkit/orchestrator.py`, `test-suite/src/x86decomp_testkit/self_tests/test_inventory_reports_process.py`, `test-suite/tests/test_inventory_reports_process.py`
- **Key imports/dependencies:** `.models`, `__future__`, `html`, `json`, `pathlib`, `typing`

## B. Functional Summary

Provide the installed test-suite implementation for the `x86decomp_testkit.reports` module. Major symbols: write_json_report, write_adapter_report, write_markdown_report, write_html_report. Static analysis recorded 9 filesystem, process, database, network, or other side-effect-relevant call(s).
...
Python parsed successfully with the standard-library AST parser. Side-effect/trust-sensitive calls reviewed: path.parent.mkdir×4, path.write_text×4, result.summary.replace×1.
...
Highest structural complexity: write_markdown_report (branches=10, AST nodes=539), write_html_report (branches=4, AST nodes=293), write_adapter_report (branches=1, AST nodes=69), write_json_report (branches=0, AST nodes=50), _status_icon (branches=0, AST nodes=35). 3 line(s) exceed 140 characters; this is a maintainability signal, not by itself a defect.
