# Per-file audit: `src/x86decomp/benchmarks.py`

## A. File Identity

- **Inventory ID:** `F0301`
- **Relative path:** `src/x86decomp/benchmarks.py`
- **SHA-256:** `9e76928e21935b743ac2360a0551ad7fc7152b2b2c3247651814913898aae8ca`
- **File size:** 7398 bytes
- **Language/format:** Python source
- **Classification:** First-party source code
- **Apparent responsibility:** Ground-truth corpus runner and decomposed benchmark metrics.
- **Provenance:** First-party or repository-maintained text
- **Review applicability:** Complete-content text/source review
- **Related files / static consumers:** `src/x86decomp/cli.py`, `test-suite/src/x86decomp_testkit/toolkit_tests/test_public_api_contract.py`
- **Key imports/dependencies:** `.diffing`, `.dynamic`, `.errors`, `.exe_diff`, `.integration`, `.symbolic`, `.util`, `__future__`, `pathlib`, `typing`

## B. Functional Summary

Ground-truth corpus runner and decomposed benchmark metrics. Major symbols: classification_metrics, run_benchmark_corpus. No side-effect-relevant call matched the audit scanner’s rule set.
...
Highest structural complexity: run_benchmark_corpus (branches=18, AST nodes=985), _resolve (branches=1, AST nodes=37), classification_metrics (branches=0, AST nodes=154). 1 line(s) exceed 140 characters; this is a maintainability signal, not by itself a defect.
...
Static search found direct symbol references in tests: classification_metrics(3), run_benchmark_corpus(3). The exact 258-test inventory passed; this is evidence of use, not a line-coverage claim.
...
- **Test confidence:** Static search found direct symbol references in tests: classification_metrics(3), run_benchmark_corpus(3). The exact 258-test inventory passed; this is evidence of use, not a line-coverage claim.
