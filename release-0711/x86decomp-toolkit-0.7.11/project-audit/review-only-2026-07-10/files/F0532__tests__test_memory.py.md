# Per-file audit: `tests/test_memory.py`

## A. File Identity

- **Inventory ID:** `F0532`
- **Relative path:** `tests/test_memory.py`
- **SHA-256:** `4f153760b7c9834097cf34ba0fa79a505627bad9b025c4c2f842c7c18ef3b1ce`
...
- **Key imports/dependencies:** `__future__`, `json`, `pathlib`, `tempfile`, `unittest`, `x86decomp.memory`

## B. Functional Summary

Executable regression tests for the behavior indicated by the filename and test symbols. Major symbols: MemoryTests, MemoryTests.test_hash_chain, MemoryTests.test_tamper_detection. Static analysis recorded 1 filesystem, process, database, network, or other side-effect-relevant call(s).
...
Python parsed successfully with the standard-library AST parser. Side-effect/trust-sensitive calls reviewed: memory.events_path.write_text×1.
...
Highest structural complexity: MemoryTests.test_tamper_detection (branches=0, AST nodes=112), MemoryTests.test_hash_chain (branches=0, AST nodes=87).
