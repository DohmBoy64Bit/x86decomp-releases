# Per-file audit: `project-audit/BASELINE.md`

## A. File Identity

- **Inventory ID:** `F0100`
- **Relative path:** `project-audit/BASELINE.md`
- **SHA-256:** `b48d56a1220e71058dd3dae3f8149d68d7c9f5d1da64d2189a03585ade24b5f0`
...
Historical human-readable audit evidence or per-file review. Principal sections: Audit Baseline — x86decomp-toolkit 0.7.11; Repository identity; Version control state; Environment; Build / test tooling detected; Repository composition (from FILE_INVENTORY.csv, built 2026-07-10); Environmental limitations (standing); Authorization constraints honored.
