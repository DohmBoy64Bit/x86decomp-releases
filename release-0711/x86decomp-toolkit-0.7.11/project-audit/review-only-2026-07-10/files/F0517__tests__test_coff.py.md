# Per-file audit: `tests/test_coff.py`

## A. File Identity

- **Inventory ID:** `F0517`
- **Relative path:** `tests/test_coff.py`
- **SHA-256:** `e1abec0d1033c65b821318e61491a5d56fbe5e109b6617210e0f1d0cbc4cb867`
- **File size:** 975 bytes
...
- **Key imports/dependencies:** `x86decomp.coff`

## B. Functional Summary

Executable regression tests for the behavior indicated by the filename and test symbols. Major symbols: test_synthetic_coff_round_trip, test_synthetic_coff_relocation. No side-effect-relevant call matched the audit scanner’s rule set.
...
Highest structural complexity: test_synthetic_coff_relocation (branches=0, AST nodes=77), test_synthetic_coff_round_trip (branches=0, AST nodes=54).
