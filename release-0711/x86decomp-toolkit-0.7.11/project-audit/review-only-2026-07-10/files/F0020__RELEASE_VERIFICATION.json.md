# Per-file audit: `RELEASE_VERIFICATION.json`

## A. File Identity

- **Inventory ID:** `F0020`
- **Relative path:** `RELEASE_VERIFICATION.json`
- **SHA-256:** `018fc226ab3329be6be880ee07aac13e378bdae69c5efbaf5905d8da00530c29`
- **File size:** 2971 bytes
- **Language/format:** JSON
- **Classification:** Generated artifact or data
- **Apparent responsibility:** Structured repository data with top-level keys: audit_findings, coverage, docstrings, gates, notes, pytest, release, status.
...
Structured repository data with top-level keys: audit_findings, coverage, docstrings, gates, notes, pytest, release, status. JSON parsing was verified; top-level type is dict.
