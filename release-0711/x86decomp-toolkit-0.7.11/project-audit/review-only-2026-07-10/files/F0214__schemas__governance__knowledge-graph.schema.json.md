# Per-file audit: `schemas/governance/knowledge-graph.schema.json`

## A. File Identity

- **Inventory ID:** `F0214`
- **Relative path:** `schemas/governance/knowledge-graph.schema.json`
...
- **Apparent responsibility:** Structured repository data with top-level keys: $schema, additionalProperties, properties, required, title, type.
...
Structured repository data with top-level keys: $schema, additionalProperties, properties, required, title, type. JSON parsing was verified; top-level type is dict.
