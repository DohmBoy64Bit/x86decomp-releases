# Per-file audit: `FEATURE_PARITY.md`

## A. File Identity

- **Inventory ID:** `F0011`
- **Relative path:** `FEATURE_PARITY.md`
- **SHA-256:** `447bfddd505ccf26863b3668a84678a2e893c4e8358ef0949a9b67cdd115bb26`
- **File size:** 2127 bytes
- **Language/format:** Markdown
- **Classification:** Documentation
- **Apparent responsibility:** Documentation centered on 'Feature parity and current surface — 0.7.11'.
...
Documentation centered on 'Feature parity and current surface — 0.7.11'. Principal sections: Feature parity and current surface — 0.7.11; Verified command surface; Binary and reconstruction scope; Contracts and packaged assets; Optional integrations; Acceptance boundaries.
