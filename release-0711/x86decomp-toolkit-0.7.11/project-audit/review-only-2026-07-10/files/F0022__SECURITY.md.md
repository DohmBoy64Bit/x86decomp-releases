...
- **SHA-256:** `a5b31ee02f32135441620fba57376eb81a1d0e8fbb0673fc4939096ba28ba369`
- **File size:** 1417 bytes
- **Language/format:** Markdown
- **Classification:** Documentation
- **Apparent responsibility:** Documentation centered on 'Security policy — 0.7.11'.
...
Documentation centered on 'Security policy — 0.7.11'. Principal sections: Security policy — 0.7.11; Controls; Reporting.
