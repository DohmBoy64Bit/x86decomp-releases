# Per-file audit: `src/x86decomp/assembly/cli.py`

## A. File Identity

- **Inventory ID:** `F0296`
- **Relative path:** `src/x86decomp/assembly/cli.py`
- **SHA-256:** `235d6ca5e3b3c571be5bb91daf88f9fe51486cd61d6e49beaf755d39d81a29b6`
- **File size:** 10573 bytes
- **Language/format:** Python source
- **Classification:** First-party source code
- **Apparent responsibility:** Provide the current runtime implementation for the `x86decomp.assembly.cli` module.
...
- **Key imports/dependencies:** `.annotation`, `.materialize`, `.pipeline`, `.relocations`, `.store`, `__future__`, `argparse`, `json`, `pathlib`, `subprocess`, `typing`, `x86decomp.cli_utils`, `x86decomp.contracts`, `x86decomp.hybrid`

## B. Functional Summary

Provide the current runtime implementation for the `x86decomp.assembly.cli` module. Major symbols: build_parser, dispatch, main. No side-effect-relevant call matched the audit scanner’s rule set.
...
Highest structural complexity: dispatch (branches=14, AST nodes=636), _json_array (branches=5, AST nodes=99), _emit (branches=3, AST nodes=66), _json_file (branches=1, AST nodes=54), build_parser (branches=0, AST nodes=728).
...
Normalized-AST duplicate group 2: src/x86decomp/assembly/cli.py:_int, src/x86decomp/cli.py:_int. Consolidation safety is assessed in CROSS_FILE_ANALYSIS.md.
