# Per-file audit: `schemas/function.schema.json`

## A. File Identity

- **Inventory ID:** `F0206`
- **Relative path:** `schemas/function.schema.json`
...
- **Apparent responsibility:** Structured repository data with top-level keys: $schema, $id, title, type, additionalProperties, required, properties, allOf.
...
Structured repository data with top-level keys: $schema, $id, title, type, additionalProperties, required, properties, allOf. JSON parsing was verified; top-level type is dict.
