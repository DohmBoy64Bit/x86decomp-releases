# Per-file audit: `project-audit/files/_group_tests.md`

## A. File Identity

- **Inventory ID:** `F0141`
- **Relative path:** `project-audit/files/_group_tests.md`
- **SHA-256:** `c7a61da406b8f406edb32181fe1f71d9bb43714e5758e44c90a916f771ecd070`
...
Historical human-readable audit evidence or per-file review. Principal sections: Grouped audit — tests/ (root suite) + test-suite/ (verification harness) (Btests); tests/ — 33 files, ~203 test functions, 666 assertions; test-suite/ (x86decomp_testkit) — separately packaged live verification harness; Findings.
...
10 line(s) exceed 140 characters; this is a maintainability signal, not by itself a defect.
