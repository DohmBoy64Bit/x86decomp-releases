# Per-file audit: `FINAL_TEST_GROUP_REPORT_0.7.11.json`

## A. File Identity

- **Inventory ID:** `F0012`
- **Relative path:** `FINAL_TEST_GROUP_REPORT_0.7.11.json`
- **SHA-256:** `7b95d2afca5c49bf7fadd2195eb4f76826869330ed26907f213d71b398a5d33c`
- **File size:** 1890 bytes
- **Language/format:** JSON
- **Classification:** Generated verification artifact
- **Apparent responsibility:** Structured repository data with top-level keys: collected, errors, failures, group_count, groups, passed, release, runner.
...
Structured repository data with top-level keys: collected, errors, failures, group_count, groups, passed, release, runner. JSON parsing was verified; top-level type is dict.
