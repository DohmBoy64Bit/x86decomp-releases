...
- **SHA-256:** `b585d982da2553421ea04052fe55fc050daf87fd1d0033ae138b0361046e72d7`
- **File size:** 1544 bytes
- **Language/format:** Makefile
- **Classification:** Configuration or packaging
- **Apparent responsibility:** Developer entry points for verification, testing, packaging, and cleanup.
...
Developer entry points for verification, testing, packaging, and cleanup.
...
Remediation and verification work is defined by: REL-001, MAINT-001.
...
- **Open questions:** After remediation, run make verify in a fresh extracted archive and prove all original file hashes remain unchanged.; Install only the documented dev extra in a clean environment and run the declared lint/type targets.
- **Related follow-up:** REL-001, MAINT-001
