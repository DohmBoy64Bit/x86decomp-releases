# Per-file audit: `tests/pe_fixture.py`

## A. File Identity

- **Inventory ID:** `F0507`
- **Relative path:** `tests/pe_fixture.py`
- **SHA-256:** `0316b722e80d1023a4b3cb0c3fdb77837842f7b9aa3d217adcb3292baa1cbb27`
...
- **Related files / static consumers:** `tests/native/test_inventory_and_loops.py`, `tests/native/test_pe_hybrid.py`, `tests/native/test_slots_matching.py`, `tests/native/test_staging_loop_runtime_windows.py`, `tests/test_linker_metadata_corpus.py`, `tests/test_modes_and_db.py`, `tests/test_pe32.py`, `tests/test_pe64_patch_hybrid.py`
- **Key imports/dependencies:** `__future__`, `pathlib`, `struct`

## B. Functional Summary

Executable regression tests for the behavior indicated by the filename and test symbols. Major symbols: build_minimal_pe32, build_minimal_pe64. Static analysis recorded 2 filesystem, process, database, network, or other side-effect-relevant call(s).
...
Python parsed successfully with the standard-library AST parser. Side-effect/trust-sensitive calls reviewed: path.write_bytes×2.
...
Highest structural complexity: build_minimal_pe64 (branches=0, AST nodes=402), build_minimal_pe32 (branches=0, AST nodes=392).
