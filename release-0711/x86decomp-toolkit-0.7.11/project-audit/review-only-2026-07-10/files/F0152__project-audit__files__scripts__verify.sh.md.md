# Per-file audit: `project-audit/files/scripts__verify.sh.md`

## A. File Identity

- **Inventory ID:** `F0152`
- **Relative path:** `project-audit/files/scripts__verify.sh.md`
- **SHA-256:** `2aab51208369f89321d243308a56175fe43c158a8b209724cd167722510b7201`
- **File size:** 773 bytes
...
Historical human-readable audit evidence or per-file review. Principal sections: Per-file audit — scripts/verify.sh; A. Identity; B. Function (read fully); M. Verdict.
