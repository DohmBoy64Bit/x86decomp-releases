...
- **Inventory ID:** `F0377`
- **Relative path:** `src/x86decomp/models.py`
...
- **Apparent responsibility:** Stable enums and dataclasses used by evidence and verification contracts.
...
- **Key imports/dependencies:** `.util`, `__future__`, `dataclasses`, `enum`, `typing`

## B. Functional Summary

Stable enums and dataclasses used by evidence and verification contracts. Major symbols: EvidenceKind, ClaimState, VerificationStatus, EvidenceItem, Claim, EvidenceItem.to_dict, Claim.to_dict. No side-effect-relevant call matched the audit scanner’s rule set.
...
Highest structural complexity: EvidenceItem.to_dict (branches=0, AST nodes=38), Claim.to_dict (branches=0, AST nodes=38).
...
Static search found direct symbol references in tests: Claim(1), ClaimState(6), EvidenceItem(1), EvidenceKind(10), VerificationStatus(7), to_dict(104). The exact 258-test inventory passed; this is evidence of use, not a line-coverage claim.
...
- **Test confidence:** Static search found direct symbol references in tests: Claim(1), ClaimState(6), EvidenceItem(1), EvidenceKind(10), VerificationStatus(7), to_dict(104). The exact 258-test inventory passed; this is evidence of use, not a line-coverage claim.
