# Per-file audit: `AUDIT_READ_RECEIPT_0.7.11.json`

## A. File Identity

- **Inventory ID:** `F0005`
- **Relative path:** `AUDIT_READ_RECEIPT_0.7.11.json`
- **SHA-256:** `51791e2447351e3e3f3b4bd83f1e3897c49871ec0483fc9023a05ea1b7758942`
- **File size:** 32247 bytes
- **Language/format:** JSON
- **Classification:** Generated verification artifact
- **Apparent responsibility:** Structured repository data with top-level keys: all_original_files_still_present, all_original_hashes_unchanged, audit_read_manifest_file_sha256, audit_root, files, files_read_in_full, original_audit_file_count, read_manifest_sha256.
...
Structured repository data with top-level keys: all_original_files_still_present, all_original_hashes_unchanged, audit_read_manifest_file_sha256, audit_root, files, files_read_in_full, original_audit_file_count, read_manifest_sha256. JSON parsing was verified; top-level type is dict.
