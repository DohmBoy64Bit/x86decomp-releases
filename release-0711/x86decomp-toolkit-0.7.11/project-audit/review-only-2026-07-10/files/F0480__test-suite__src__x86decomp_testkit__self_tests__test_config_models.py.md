# Per-file audit: `test-suite/src/x86decomp_testkit/self_tests/test_config_models.py`

## A. File Identity

- **Inventory ID:** `F0480`
- **Relative path:** `test-suite/src/x86decomp_testkit/self_tests/test_config_models.py`
- **SHA-256:** `f9e1bf8dc24dcb6262fa774d149f5ab28b7214146a6b86e2cfc544efe32f3f3e`
- **File size:** 2442 bytes
- **Language/format:** Python source
- **Classification:** Packaged test code
- **Apparent responsibility:** Provide the installed test-suite implementation for the `x86decomp_testkit.self_tests.test_config_models` module.
- **Provenance:** First-party or repository-maintained text
- **Review applicability:** Complete-content text/source review
- **Related files / static consumers:** `test-suite/tests/test_config_models.py`
- **Key imports/dependencies:** `__future__`, `json`, `pathlib`, `x86decomp_testkit.config`, `x86decomp_testkit.models`

## B. Functional Summary

Provide the installed test-suite implementation for the `x86decomp_testkit.self_tests.test_config_models` module. Major symbols: test_config_roundtrip_and_relative_resolution, test_status_counts_and_strict_exit_code, test_status_counts_and_strict_exit_code.result. Static analysis recorded 1 filesystem, process, database, network, or other side-effect-relevant call(s).
...
Highest structural complexity: test_status_counts_and_strict_exit_code (branches=0, AST nodes=184), test_config_roundtrip_and_relative_resolution (branches=0, AST nodes=144), test_status_counts_and_strict_exit_code.result (branches=0, AST nodes=21).
...
Executed in the separate packaged-self-test replay: 2 test function(s); the 21-test package replay passed.
...
- **Test confidence:** Executed in the separate packaged-self-test replay: 2 test function(s); the 21-test package replay passed.
