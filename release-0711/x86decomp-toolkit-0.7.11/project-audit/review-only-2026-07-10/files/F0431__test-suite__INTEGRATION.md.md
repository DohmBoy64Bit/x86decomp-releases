# Per-file audit: `test-suite/INTEGRATION.md`

## A. File Identity

- **Inventory ID:** `F0431`
- **Relative path:** `test-suite/INTEGRATION.md`
- **SHA-256:** `378c0c34e8ab00d53107ef7259fd1e2cd04a3299acf1ec4f488d326a8895fafa`
- **File size:** 637 bytes
- **Language/format:** Markdown
- **Classification:** Documentation
- **Apparent responsibility:** Documentation centered on 'Test-suite integration — 0.7.11'.
...
Documentation centered on 'Test-suite integration — 0.7.11'. Principal sections: Test-suite integration — 0.7.11.
