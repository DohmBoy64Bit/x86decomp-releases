...
- **Inventory ID:** `F0018`
- **Relative path:** `PROJECT_MEMORY.md`
- **SHA-256:** `3f0b2a725fb04f7250524ee62a4244ed1e869b2c86e259fcad033ee97a11aa39`
- **File size:** 1727 bytes
- **Language/format:** Markdown
- **Classification:** Documentation
- **Apparent responsibility:** Documentation centered on 'Project memory — x86decomp-toolkit 0.7.11'.
...
Documentation centered on 'Project memory — x86decomp-toolkit 0.7.11'. Principal sections: Project memory — x86decomp-toolkit 0.7.11; Durable architecture decision; Stable product decisions; Release discipline; Adapter capability decision.
