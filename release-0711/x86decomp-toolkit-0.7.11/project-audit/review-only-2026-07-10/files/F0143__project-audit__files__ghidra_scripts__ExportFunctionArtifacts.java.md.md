# Per-file audit: `project-audit/files/ghidra_scripts__ExportFunctionArtifacts.java.md`

## A. File Identity

- **Inventory ID:** `F0143`
- **Relative path:** `project-audit/files/ghidra_scripts__ExportFunctionArtifacts.java.md`
- **SHA-256:** `1e7d04edf67e6fc6348fe8dbb242a4610820abb29ef6bf4c09333da1c13d759f`
...
Historical human-readable audit evidence or per-file review. Principal sections: Per-file audit — ghidra_scripts/ExportFunctionArtifacts.java; A. Identity; B. Function (read fully, 499 lines); C/H. Correctness/Security; M. Verdict.
...
2 line(s) exceed 140 characters; this is a maintainability signal, not by itself a defect.
