...
- **Inventory ID:** `F0023`
- **Relative path:** `VERIFICATION.md`
- **SHA-256:** `a7198c375c2ece0a1e8be9ec6a5a1a206a0e0cb21f2d32256533d6324753efb3`
- **File size:** 1494 bytes
- **Language/format:** Markdown
- **Classification:** Documentation
- **Apparent responsibility:** Documentation centered on 'Verification contract — 0.7.11'.
...
Documentation centered on 'Verification contract — 0.7.11'. Principal sections: Verification contract — 0.7.11; Required evidence; Adapter verification.
