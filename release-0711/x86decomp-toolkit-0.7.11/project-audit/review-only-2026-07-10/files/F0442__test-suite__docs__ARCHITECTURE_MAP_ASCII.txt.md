# Per-file audit: `test-suite/docs/ARCHITECTURE_MAP_ASCII.txt`

## A. File Identity

- **Inventory ID:** `F0442`
- **Relative path:** `test-suite/docs/ARCHITECTURE_MAP_ASCII.txt`
- **SHA-256:** `9b6a765311addfb49f588f7b7b9b1d6f0fb2983fcd67077135b8c42d4134ec5e`
- **File size:** 3035 bytes
- **Language/format:** Plain text
- **Classification:** Documentation
- **Apparent responsibility:** Repository plain text asset.
