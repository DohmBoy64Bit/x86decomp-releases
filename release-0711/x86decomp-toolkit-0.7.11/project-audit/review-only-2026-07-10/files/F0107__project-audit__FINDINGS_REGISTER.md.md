# Per-file audit: `project-audit/FINDINGS_REGISTER.md`

## A. File Identity

- **Inventory ID:** `F0107`
- **Relative path:** `project-audit/FINDINGS_REGISTER.md`
- **SHA-256:** `f28ce6cb070ba31353a1f4ad112a1aa6b84f031fe217bac19e712ab477984406`
...
Historical human-readable audit evidence or per-file review. Principal sections: Findings Register — x86decomp-toolkit 0.7.11; REPO-001 — Shipped integrity manifest does not match shipped files; REPO-001 (update 2026-07-10); REPO-002 — Machine-local harness config committed at release root; REPO-003 — Release tree contaminated with working-state byproducts; REPO-004 — Ignore rules do not match documented invocation paths; REPO-005 — Shipped dist/ artifacts diverge from shipped sources; TEST-001 — Full-suite pytest completion is not demonstrated by shipped evidence.
...
37 Markdown heading(s) structure the document; local targets were checked repository-wide.

Documentation was judged proportionally: public/non-obvious behavior requires specific contracts, while trivial fixtures and data files do not require artificial prose.

## E. Code Quality and Maintainability

56 line(s) exceed 140 characters; this is a maintainability signal, not by itself a defect.
