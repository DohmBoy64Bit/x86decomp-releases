# Per-file audit: `test-suite/src/x86decomp_testkit/timeutil.py`

## A. File Identity

- **Inventory ID:** `F0483`
- **Relative path:** `test-suite/src/x86decomp_testkit/timeutil.py`
- **SHA-256:** `6df8b1ab942b3c5544c0b6130be135cc4cee196c603a2c0a58c561735e609a72`
- **File size:** 336 bytes
- **Language/format:** Python source
- **Classification:** First-party verification-harness source
- **Apparent responsibility:** Provide the installed test-suite implementation for the `x86decomp_testkit.timeutil` module.
- **Provenance:** First-party or repository-maintained text
- **Review applicability:** Complete-content text/source review
- **Related files / static consumers:** `test-suite/src/x86decomp_testkit/live_adapters.py`, `test-suite/src/x86decomp_testkit/logging_utils.py`, `test-suite/src/x86decomp_testkit/orchestrator.py`, `test-suite/src/x86decomp_testkit/process.py`, `test-suite/src/x86decomp_testkit/suites.py`
- **Key imports/dependencies:** `__future__`, `datetime`

## B. Functional Summary

Provide the installed test-suite implementation for the `x86decomp_testkit.timeutil` module. Major symbols: utc_now. No side-effect-relevant call matched the audit scanner’s rule set.
...
Highest structural complexity: utc_now (branches=0, AST nodes=26).
