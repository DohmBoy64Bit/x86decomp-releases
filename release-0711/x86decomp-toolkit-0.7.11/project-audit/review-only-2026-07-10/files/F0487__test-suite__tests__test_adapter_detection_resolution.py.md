# Per-file audit: `test-suite/tests/test_adapter_detection_resolution.py`

## A. File Identity

- **Inventory ID:** `F0487`
- **Relative path:** `test-suite/tests/test_adapter_detection_resolution.py`
- **SHA-256:** `7bd6c6fd94d35d1d0773bc1afd6d8b54e63cc8cafbfad512bed398b8f267cd1e`
- **File size:** 6070 bytes
...
- **Related files / static consumers:** `test-suite/src/x86decomp_testkit/self_tests/test_adapter_detection_resolution.py`
...
Executable regression tests for the behavior indicated by the filename and test symbols. Major symbols: test_installed_adapter_never_prompts, test_missing_adapter_prompts_custom_path_then_accepts, test_missing_noninteractive_is_explicit_unresolved, test_environment_and_configured_root_detection, test_path_detection_preserves_symlink_argv0, test_missing_python_adapter_accepts_custom_interpreter, test_installed_adapter_never_prompts.prompt, test_missing_adapter_prompts_custom_path_then_accepts.prompt. Static analysis recorded 8 filesystem, process, database, network, or other side-effect-relevant call(s).
