# Per-file audit: `tests/test_compiler.py`

## A. File Identity

- **Inventory ID:** `F0519`
- **Relative path:** `tests/test_compiler.py`
- **SHA-256:** `e68de06c0c112667d0f8b880318fef9c7423ec9a06f4192fefd9a90f5e2490ee`
...
- **Key imports/dependencies:** `__future__`, `pathlib`, `shutil`, `tempfile`, `unittest`, `x86decomp.compiler`

## B. Functional Summary

Executable regression tests for the behavior indicated by the filename and test symbols. Major symbols: CompilerTests, CompilerTests.test_compile_i386_object. No side-effect-relevant call matched the audit scanner’s rule set.
...
Highest structural complexity: CompilerTests.test_compile_i386_object (branches=0, AST nodes=106).
