# Per-file audit: `project-audit/files/src__x86decomp__models.py.md`

## A. File Identity

- **Inventory ID:** `F0170`
- **Relative path:** `project-audit/files/src__x86decomp__models.py.md`
- **SHA-256:** `d8ae79a8c93dfaf1700706a4bf0d48b5d5e86c3f95ba44c4c962a4fe28fb4524`
...
Historical human-readable audit evidence or per-file review. Principal sections: Per-file audit — src/x86decomp/models.py; A. Identity; B. Function (read fully, 99 lines); C. Correctness; L. Findings; M. Verdict.
