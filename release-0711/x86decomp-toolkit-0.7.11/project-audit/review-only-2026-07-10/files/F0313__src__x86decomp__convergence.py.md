# Per-file audit: `src/x86decomp/convergence.py`

## A. File Identity

- **Inventory ID:** `F0313`
- **Relative path:** `src/x86decomp/convergence.py`
- **SHA-256:** `3c147aa3dd24d9f3290b1c275031c0209ac915c877e3291b4d1cef3ef4f9321e`
- **File size:** 7462 bytes
- **Language/format:** Python source
- **Classification:** First-party source code
- **Apparent responsibility:** Target-specific whole-image convergence analysis.
- **Provenance:** First-party or repository-maintained text
- **Review applicability:** Complete-content text/source review
- **Related files / static consumers:** `src/x86decomp/cli.py`, `tests/test_production.py`
- **Key imports/dependencies:** `.errors`, `.image_match`, `.pe`, `.util`, `__future__`, `json`, `pathlib`, `typing`

## B. Functional Summary

Target-specific whole-image convergence analysis. Major symbols: analyze_image_convergence, append_convergence_history. Static analysis recorded 1 filesystem, process, database, network, or other side-effect-relevant call(s).
...
Python parsed successfully with the standard-library AST parser. Side-effect/trust-sensitive calls reviewed: history_path.parent.mkdir×1.
...
Highest structural complexity: analyze_image_convergence (branches=16, AST nodes=708), _section_kind (branches=7, AST nodes=88), append_convergence_history (branches=2, AST nodes=133). 2 line(s) exceed 140 characters; this is a maintainability signal, not by itself a defect.
...
Static search found direct symbol references in tests: analyze_image_convergence(4), append_convergence_history(3). The exact 258-test inventory passed; this is evidence of use, not a line-coverage claim.
...
- **Test confidence:** Static search found direct symbol references in tests: analyze_image_convergence(4), append_convergence_history(3). The exact 258-test inventory passed; this is evidence of use, not a line-coverage claim.
