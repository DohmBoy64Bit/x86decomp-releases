# Per-file audit: `examples/release/release-gate-policy.json`

## A. File Identity

- **Inventory ID:** `F0081`
- **Relative path:** `examples/release/release-gate-policy.json`
- **SHA-256:** `7ad41612264a71c3bd1d1ea44b5ad0f9145710ef926492975796dd9264948026`
- **File size:** 425 bytes
- **Language/format:** JSON
- **Classification:** Example or sample
- **Apparent responsibility:** Structured repository data with top-level keys: schema_version, require_workflows, require_verified_claims, require_succeeded_pipelines, require_reproduction_manifest, require_security_report, require_whole_image_convergence, truth_scope.
...
Structured repository data with top-level keys: schema_version, require_workflows, require_verified_claims, require_succeeded_pipelines, require_reproduction_manifest, require_security_report, require_whole_image_convergence, truth_scope. JSON parsing was verified; top-level type is dict.
