# Per-file audit: `test-suite/scripts/run-all.ps1`

## A. File Identity

- **Inventory ID:** `F0451`
- **Relative path:** `test-suite/scripts/run-all.ps1`
- **SHA-256:** `29211e8199239685346d666b03824714984db61c73526a8ebc8fb1bd461273cf`
- **File size:** 146 bytes
- **Language/format:** PowerShell
- **Classification:** Test code
- **Apparent responsibility:** Repository powershell asset.
