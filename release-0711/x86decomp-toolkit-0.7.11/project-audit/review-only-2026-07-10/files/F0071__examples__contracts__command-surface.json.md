# Per-file audit: `examples/contracts/command-surface.json`

## A. File Identity

- **Inventory ID:** `F0071`
- **Relative path:** `examples/contracts/command-surface.json`
- **SHA-256:** `85a67b1da249fa898cfa7b65c7cbd1c1896297993cc547e8823ddd440a50d5e2`
- **File size:** 7977 bytes
- **Language/format:** JSON
- **Classification:** Example or sample
- **Apparent responsibility:** Structured repository data with top-level keys: canonical_groups, canonical_route_count, commands, release, schema_files.
...
Structured repository data with top-level keys: canonical_groups, canonical_route_count, commands, release, schema_files. JSON parsing was verified; top-level type is dict.
