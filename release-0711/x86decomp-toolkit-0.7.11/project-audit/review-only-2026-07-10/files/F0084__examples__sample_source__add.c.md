# Per-file audit: `examples/sample_source/add.c`

## A. File Identity

- **Inventory ID:** `F0084`
- **Relative path:** `examples/sample_source/add.c`
- **SHA-256:** `860aaedc4520b18df5ce99de71a36487eb333dcdb09f65fce222677c8fe8cd97`
- **File size:** 58 bytes
