# Per-file audit: `examples/symbolic/symbolic-alias-harness.json`

## A. File Identity

- **Inventory ID:** `F0085`
- **Relative path:** `examples/symbolic/symbolic-alias-harness.json`
- **SHA-256:** `e5bbc6d9470e269f41051e95a444a9218f9919140bc74070dd223caf4eb7c130`
- **File size:** 532 bytes
- **Language/format:** JSON
- **Classification:** Example or sample
- **Apparent responsibility:** Structured repository data with top-level keys: architecture, regions, alias_constraints, observe_memory, output_registers, alias_slots, max_steps, max_paths.
...
Structured repository data with top-level keys: architecture, regions, alias_constraints, observe_memory, output_registers, alias_slots, max_steps, max_paths. JSON parsing was verified; top-level type is dict.
