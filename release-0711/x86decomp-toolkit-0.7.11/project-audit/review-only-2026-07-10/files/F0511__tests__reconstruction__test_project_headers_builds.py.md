# Per-file audit: `tests/reconstruction/test_project_headers_builds.py`

## A. File Identity

- **Inventory ID:** `F0511`
- **Relative path:** `tests/reconstruction/test_project_headers_builds.py`
...
- **Key imports/dependencies:** `__future__`, `pathlib`, `pytest`, `x86decomp.contracts`, `x86decomp.reconstruction.builds`, `x86decomp.reconstruction.headers`, `x86decomp.reconstruction.project_layout`, `x86decomp.reconstruction.store`

## B. Functional Summary

Executable regression tests for the behavior indicated by the filename and test symbols. Major symbols: test_store_is_additive_and_layout_is_evidence_labeled, test_headers_reject_cycles_and_generate_compileable_shape, test_historical_and_portable_build_modes_remain_distinct. No side-effect-relevant call matched the audit scanner’s rule set.
...
Highest structural complexity: test_store_is_additive_and_layout_is_evidence_labeled (branches=2, AST nodes=225), test_historical_and_portable_build_modes_remain_distinct (branches=1, AST nodes=237), test_headers_reject_cycles_and_generate_compileable_shape (branches=1, AST nodes=170).
