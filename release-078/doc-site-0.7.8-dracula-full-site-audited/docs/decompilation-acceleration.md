...
description: 0.7.8 helpers for moving from function evidence to accepted, source-organized reconstruction work.
---

# Decompilation acceleration workflow

The 0.7.8 acceleration commands remove manual glue around local-model jobs, accepted-source promotion, source-address annotations, C++ metadata scaffolding, triage, playability smoke plans, assets, and mod/regression manifests.
