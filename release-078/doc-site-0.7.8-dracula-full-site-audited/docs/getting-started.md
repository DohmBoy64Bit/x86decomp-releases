...
These commands were parsed against the actual 0.7.8 toolkit and verification-harness parsers.
...
python -m pip install .\x86decomp_test_suite-0.7.8-py3-none-any.whl
```
