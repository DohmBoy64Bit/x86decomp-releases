...
description: Exact v0.7.8 parser-derived reference for `x86decomp corpus-create-manifest`.
---
...
| --- | --- |
| `repository` | required · type: `_path` · parser destination: `repository`. No help text declared. |
