...
description: Exact v0.7.8 parser-derived reference for `x86decomp test-bundle-inspect`.
---
...
| --- | --- |
| `bundle` | required · type: `_path` · parser destination: `bundle`. No help text declared. |
