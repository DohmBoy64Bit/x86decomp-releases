...
> **Source-verified project examples.** See [Project examples](project-examples.md) for matching, functional, both-mode hybrid, and major supporting workflows grounded in the 0.7.8 source.

> **Audit status.** Every x86decomp and x86decomp-test command on this page parses with the real 0.7.8 parser. Runtime success still depends on the declared input files, tools, and authorization boundary.
