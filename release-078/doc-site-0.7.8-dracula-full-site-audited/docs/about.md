---
title: About
description: Source-of-truth policy for the 0.7.8 documentation.
---

# About x86decomp and this site

This site documents x86decomp-toolkit 0.7.8 and is regenerated from the release parser, source AST, schemas, adapters, manifests, tests, and maintained project examples.
