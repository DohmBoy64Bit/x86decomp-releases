# Comprehensive test plan — 0.7.8

## Exact current inventory

The feature catalog pins 114 Python modules, 948 function and method bodies, 166 root commands, 59 canonical groups, 239 canonical routes, 97 schemas, 3 Ghidra scripts, and 36 adapter contracts.
...
The current adapter catalog contains 37 adapters, including the v0.7.8 `lm-studio-http` endpoint adapter.
