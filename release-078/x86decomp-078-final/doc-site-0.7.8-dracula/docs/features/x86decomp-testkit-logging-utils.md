...
**SHA-256:** `973448e1f8708f80d4efebeec3246c51f90f35e6e1088a620d363b9767af0e8c`  
**Functions/methods:** 3
...
```python
def JsonlEventLogger.__init__(self, path: Path)
```
...
```python
def JsonlEventLogger.emit(self, event: str, **fields: Any) -> None
```
