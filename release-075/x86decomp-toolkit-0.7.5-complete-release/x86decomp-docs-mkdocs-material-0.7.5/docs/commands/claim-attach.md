...
description: Exact parser-derived reference for x86decomp claim-attach in 0.7.5.
---
...
```text
x86decomp claim-attach [-h] project claim_id evidence_id
```
...
| `claim_id` | required. No help text is declared; parser destination is `claim_id`. |
