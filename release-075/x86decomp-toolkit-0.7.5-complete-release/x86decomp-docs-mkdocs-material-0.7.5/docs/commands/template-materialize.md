---
title: x86decomp template-materialize
description: Exact parser-derived reference for x86decomp template-materialize in
  0.7.5.
---
...
```text
x86decomp template-materialize [-h] project
```
