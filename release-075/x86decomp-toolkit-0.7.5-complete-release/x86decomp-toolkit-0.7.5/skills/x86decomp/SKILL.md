...
description: Evidence-first operation of the unified x86decomp-toolkit 0.7.5 release.
version: 7.5.0
license: Apache-2.0
compatibility: Python 3.11+, x86decomp-toolkit 0.7.5, native PE32/i386 and PE32+/AMD64, optional bounded validation adapters
metadata:
  release_contract: 0.7.5
  ...
  canonical_group_count: 34
  canonical_route_count: 181
...
The toolkit exposes 34 canonical capability groups and 181 routes. Do not create release-numbered modules, executables, command bridges, installers, overlays, reports, catalogs, or tests.
