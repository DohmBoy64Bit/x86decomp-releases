...
def main() -> int:
    ...
    if stale:
        errors.append("stale 0.7.4 references in current site source: " + ", ".join(stale[:20]))
    ...
    print("Dracula-styled 0.7.5 docs, release artifacts, built pages, search index, and local links verified.")
    return 0
