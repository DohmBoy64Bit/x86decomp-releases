---
title: x86decomp project-gc
description: Exact parser-derived reference for x86decomp project-gc in 0.7.5.
---
...
```text
x86decomp project-gc [-h] [--apply] project
```
...
| `--apply` | default: `False` · nargs: `0`. No help text is declared; parser destination is `apply`. |
