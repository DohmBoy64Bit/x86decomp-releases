...
Coverage is supplemented by exact source manifests, recursive schema validation, Java
syntax, skill frontmatter, architecture-map synchronization, current capability
contracts, project backup/restore, pipeline resumability, concurrency/cancellation,
clean package installation, and real adapter probes.
