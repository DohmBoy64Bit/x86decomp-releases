"""Provide tests.test_evidence functionality for the x86decomp-toolkit 0.7.9 release.
...
class EvidenceTests(unittest.TestCase):
    """Implement the EvidenceTests class using its declared base class contract.
    ...
    def test_three_independent_sources_verify_claim(self) -> None:
        """Verify three independent sources verify claim.
    ...
    def test_same_group_does_not_verify(self) -> None:
        """Verify same group does not verify.
