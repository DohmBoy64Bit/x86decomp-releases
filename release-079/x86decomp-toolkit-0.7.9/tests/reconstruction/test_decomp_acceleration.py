"""Provide tests.reconstruction.test_decomp_acceleration functionality for the x86decomp-toolkit 0.7.9 release.
...
def test_llm_job_create_and_range(tmp_path: Path) -> None:
    """Verify llm job create and range.
...
def test_source_map_and_candidate_promotion(tmp_path: Path) -> None:
    """Verify source map and candidate promotion.
