"""Provide tests.test_coff_archive functionality for the x86decomp-toolkit 0.7.9 release.
...
def test_real_coff_archive_members_symbols_and_comdat(tmp_path: Path) -> None:
    """Verify real coff archive members symbols and comdat.
...
def test_static_library_is_inspected_in_safe_bundle(tmp_path: Path) -> None:
    """Verify static library is inspected in safe bundle.
...
def test_real_import_library_records(tmp_path: Path) -> None:
    """Verify real import library records.
