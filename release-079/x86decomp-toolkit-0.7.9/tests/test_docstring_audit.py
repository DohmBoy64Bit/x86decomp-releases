"""Regression tests for complete 0.7.9 docstring coverage."""
...
def test_docstring_audit_report_matches_current_release() -> None:
    ...
    report = json.loads((ROOT / "DOCSTRING_AUDIT_0.7.9.json").read_text(encoding="utf-8"))
    assert report["release"] == "0.7.9"
...
def test_command_reference_matches_canonical_surface() -> None:
    ...
    reference = json.loads((ROOT / "docs" / "COMMAND_REFERENCE_0.7.9.json").read_text(encoding="utf-8"))
