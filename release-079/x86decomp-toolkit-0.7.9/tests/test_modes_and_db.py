"""Provide tests.test_modes_and_db functionality for the x86decomp-toolkit 0.7.9 release.
...
def test_independent_modes_and_monotonic_state(tmp_path: Path) -> None:
    """Verify independent modes and monotonic state.
...
def test_type_constraint_conflict_gate(tmp_path: Path) -> None:
    """Verify type constraint conflict gate.
