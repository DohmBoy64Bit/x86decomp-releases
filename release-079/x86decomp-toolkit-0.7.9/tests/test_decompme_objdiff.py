"""Provide tests.test_decompme_objdiff functionality for the x86decomp-toolkit 0.7.9 release.
...
def test_create_local_decompme_packet(tmp_path: Path) -> None:
    """Verify create local decompme packet.
...
def test_manifest_driven_objdiff_adapter(tmp_path: Path) -> None:
    """Verify manifest driven objdiff adapter.
