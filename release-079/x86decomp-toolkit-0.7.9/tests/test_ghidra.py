"""Provide tests.test_ghidra functionality for the x86decomp-toolkit 0.7.9 release.
...
class GhidraCommandTests(unittest.TestCase):
    """Implement the GhidraCommandTests class using its declared base class contract.
    ...
    def test_build_export_command_is_argument_array(self) -> None:
        """Verify build export command is argument array.
