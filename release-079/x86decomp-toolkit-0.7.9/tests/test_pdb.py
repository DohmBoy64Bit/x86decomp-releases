"""Provide tests.test_pdb functionality for the x86decomp-toolkit 0.7.9 release.
...
def test_invalid_pdb_is_rejected() -> None:
    """Verify invalid pdb is rejected.
...
def test_real_lld_pdb_inventory_identity_and_bundle(tmp_path: Path) -> None:
    """Verify real lld pdb inventory identity and bundle.
