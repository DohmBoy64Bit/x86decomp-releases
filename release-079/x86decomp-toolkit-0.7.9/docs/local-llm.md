...
## 0.7.9 decompilation acceleration loop

0.7.9 adds the missing job materialization and queue-management layer around the existing local-model proposal loop:
...
## 0.7.9 harness capability mapping
