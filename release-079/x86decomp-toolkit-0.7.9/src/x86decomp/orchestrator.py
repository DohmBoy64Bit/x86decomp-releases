...
class PipelineStage:
    """Store the validated fields for pipeline stage records.
...
class PipelineManifest:
    """Store the validated fields for pipeline manifest records.
...
class Orchestrator:
    """Represent orchestrator state and behavior.
    ...
    def _run_stage(self, manifest: PipelineManifest, stage: PipelineStage, job_id: str) -> dict[str, Any]:
        ...
        def cancellation_requested() -> bool:
            """Implement cancellation requested.
