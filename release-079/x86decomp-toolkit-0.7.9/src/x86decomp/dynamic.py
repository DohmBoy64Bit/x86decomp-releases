...
class MemoryRegion:
    """Store the validated fields for memory region records.
...
@dataclass(frozen=True)
class ExecutionSpec:
    """Store the validated fields for execution spec records.
...
def differential_validate(
    ...
    *,
    ...
    """Implement differential validate.
...
def differential_validate_files(
    ...
    *,
    ...
    """Implement differential validate files.
