"""Provide x86decomp.reconstruction.semantic_changesets functionality for the x86decomp-toolkit 0.7.9 release.
...
class SemanticChangeSets:
    """Represent semantic change sets state and behavior.
