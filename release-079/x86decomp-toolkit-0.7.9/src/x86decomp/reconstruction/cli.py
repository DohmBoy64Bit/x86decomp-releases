"""Provide x86decomp.reconstruction.cli functionality for the x86decomp-toolkit 0.7.9 release.
...
def build_parser(*,prog:str='x86decomp-reconstruction')->argparse.ArgumentParser:
    ...
    Parameters and return values follow the signature and runtime validation in the body.
    """
    parser=argparse.ArgumentParser(prog=prog,description='x86decomp-toolkit 0.7.9 project-scale reconstruction control plane')
