"""Provide x86decomp.native.windows_tools functionality for the x86decomp-toolkit 0.7.9 release.
...
def discover_ghidra_launcher(ghidra_home:Path|None=None, *, platform_name:str|None=None)->Path|None:
    """Implement discover ghidra launcher.
...
class WindowsTools:
    """Represent windows tools state and behavior.
