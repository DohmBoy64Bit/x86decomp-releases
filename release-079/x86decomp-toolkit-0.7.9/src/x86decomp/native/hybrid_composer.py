"""Provide x86decomp.native.hybrid_composer functionality for the x86decomp-toolkit 0.7.9 release.
...
class HybridComposer:
    """Represent hybrid composer state and behavior.
    ...
    def compose(self, run_id:str, output_path:Path, *, actor:str='analyst')->dict[str,Any]:
        """Compose the requested operation.
