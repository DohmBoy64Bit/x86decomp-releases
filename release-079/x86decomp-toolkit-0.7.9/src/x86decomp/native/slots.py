"""Provide x86decomp.native.slots functionality for the x86decomp-toolkit 0.7.9 release.
...
def inventory_from_project(project_root: Path) -> list[dict[str, Any]]:
    """Implement inventory from project.
...
class FunctionSlots:
    """Represent function slots state and behavior.
