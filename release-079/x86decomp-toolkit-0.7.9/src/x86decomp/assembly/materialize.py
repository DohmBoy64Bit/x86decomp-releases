"""Provide x86decomp.assembly.materialize functionality for the x86decomp-toolkit 0.7.9 release.
...
class InstructionCandidate:
    """Store the validated fields for instruction candidate records.
...
def _replace_address_token(op_str: str, address: int, symbol: str) -> str | None:
    """Implement replace address token.
...
def _instruction_candidates(
    ...
    *,
    ...
    """Implement instruction candidates.
