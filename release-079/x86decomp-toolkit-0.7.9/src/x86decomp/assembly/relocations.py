"""Provide x86decomp.assembly.relocations functionality for the x86decomp-toolkit 0.7.9 release.
...
class SymbolAddress:
    """Store the validated fields for symbol address records.
...
def supported_relocations() -> dict[str, list[str]]:
    """Implement supported relocations.
...
def _object_symbol_target(
    ...
    *,
    ...
    """Implement object symbol target.
