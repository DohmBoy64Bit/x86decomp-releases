...
class ModelResponse:
    """Store the validated fields for model response records.
...
class _SameOriginRedirectHandler(HTTPRedirectHandler):
    """Implement the _SameOriginRedirectHandler class using its declared base class contract.
    
    Attributes, invariants, and helper methods are defined by the class body.
    """
    def redirect_request(self, req: Request, fp: Any, code: int, msg: str, headers: Any, newurl: str) -> Request | None:
        """Implement redirect request.
...
def _ollama_model_matches(requested: str, available: str) -> bool:
    """Implement ollama model matches.
