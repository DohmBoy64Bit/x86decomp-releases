...
class PDBStream:
    """Store the validated fields for p d b stream records.
...
@dataclass(frozen=True)
class PDBFile:
    """Store the validated fields for p d b file records.
...
class _MSF:
    """Represent m s f state and behavior.
