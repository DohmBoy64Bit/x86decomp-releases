...
class CallingConvention(StrEnum):
    """Enumerate the supported calling convention values.
...
class FloatMode(StrEnum):
    """Enumerate the supported float mode values.
...
class ABIContract:
    """Store the validated fields for a b i contract records.
    ...
    def from_dict(cls, value: Any) -> "ABIContract":
        ...
        def optional_nonnegative(key: str) -> int | None:
            """Implement optional nonnegative.
