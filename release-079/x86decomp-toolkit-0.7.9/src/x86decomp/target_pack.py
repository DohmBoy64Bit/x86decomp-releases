...
class SupportingArtifact:
    """Store the validated fields for supporting artifact records.
...
def generate_project_from_target_pack(
    ...
    *,
    ...
    project = initialize_project(primary, project_root, copy_binary=copy_binary)
