...
class MapSegment:
    """Store the validated fields for map segment records.
...
class MapContribution:
    """Store the validated fields for map contribution records.
...
@dataclass(frozen=True)
class MapPublic:
    """Store the validated fields for map public records.
...
@dataclass(frozen=True)
class LinkerMap:
    """Store the validated fields for linker map records.
...
def reconstruct_linker_layout(
    ...
    *,
    ...
    """Implement reconstruct linker layout.
