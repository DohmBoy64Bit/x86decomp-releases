"""Provide x86decomp.governance.plugins functionality for the x86decomp-toolkit 0.7.9 release.
...
class PluginRegistry:
    """Represent plugin registry state and behavior.
    ...
    def install(self, manifest_path: str | Path, *, actor: str = "analyst") -> dict[str, Any]:
        """Install the requested operation.
