...
class UnsupportedSymbolicInstruction(ContractError):
    """Implement the UnsupportedSymbolicInstruction class using its declared base class contract.
...
@dataclass
class SymState:
    """Store the validated fields for sym state records.
...
class Outcome:
    """Store the validated fields for outcome records.
...
def bounded_symbolic_compare(
    ...
    *,
    ...
    """Implement bounded symbolic compare.
...
def bounded_symbolic_compare_files(
    ...
    **kwargs: Any,
    ...
    """Implement bounded symbolic compare files.
