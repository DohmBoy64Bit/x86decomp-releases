...
class DataDirectory:
    """Store the validated fields for data directory records.
...
@dataclass(frozen=True)
class Section:
    """Store the validated fields for section records.
...
@dataclass(frozen=True)
class ImportSymbol:
    """Store the validated fields for import symbol records.
...
@dataclass(frozen=True)
class ImportLibrary:
    """Store the validated fields for import library records.
...
@dataclass(frozen=True)
class ExportSymbol:
    """Store the validated fields for export symbol records.
...
class BaseRelocation:
    """Store the validated fields for base relocation records.
...
@dataclass(frozen=True)
class DebugRecord:
    """Store the validated fields for debug record records.
...
@dataclass(frozen=True)
class TLSInfo:
    """Store the validated fields for t l s info records.
...
@dataclass(frozen=True)
class ResourceLeaf:
    """Store the validated fields for resource leaf records.
...
class DelayImportLibrary:
    """Store the validated fields for delay import library records.
...
class LoadConfigInfo:
    """Store the validated fields for load config info records.
...
@dataclass(frozen=True)
class PE32Image:
    """Store the validated fields for p e32 image records.
