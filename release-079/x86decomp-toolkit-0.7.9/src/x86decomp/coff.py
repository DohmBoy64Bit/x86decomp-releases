...
def relocation_is_pc_relative(machine: int, relocation_type: int) -> bool:
    """Implement relocation is pc relative.
...
class CoffRelocation:
    """Store the validated fields for coff relocation records.
...
class SectionDefinitionAux:
    """Store the validated fields for section definition aux records.
...
class FunctionDefinitionAux:
    """Store the validated fields for function definition aux records.
...
class WeakExternalAux:
    """Store the validated fields for weak external aux records.
...
@dataclass(frozen=True)
class FileAux:
    """Store the validated fields for file aux records.
...
@dataclass(frozen=True)
class RawAux:
    """Store the validated fields for raw aux records.
...
@dataclass(frozen=True)
class CoffSection:
    """Store the validated fields for coff section records.
    ...
    def comdat_selection_name(self) -> str:
        """Implement comdat selection name.
...
@dataclass(frozen=True)
class CoffSymbol:
    """Store the validated fields for coff symbol records.
...
@dataclass(frozen=True)
class CoffObject:
    """Store the validated fields for coff object records.
...
class ExtractedSymbol:
    """Store the validated fields for extracted symbol records.
...
class ComdatCandidate:
    """Store the validated fields for comdat candidate records.
...
class ComdatResolution:
    """Store the validated fields for comdat resolution records.
...
class SyntheticSymbolSpec:
    """Store the validated fields for synthetic symbol spec records.
...
class SyntheticSectionSpec:
    """Store the validated fields for synthetic section spec records.
...
class _Reader:
    """Represent reader state and behavior.
...
def synthetic_symbol_indices(symbols: Sequence[SyntheticSymbolSpec]) -> dict[str, int]:
    """Implement synthetic symbol indices.
