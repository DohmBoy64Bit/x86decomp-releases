...
class MCPTool:
    """Store the validated fields for m c p tool records.
...
class StdioMCPClient:
    """Represent stdio m c p client state and behavior.
...
class StreamableHTTPMCPClient:
    """Represent streamable h t t p m c p client state and behavior.
...
def is_probable_mutation(tool_name: str) -> bool:
    """Implement is probable mutation.
