"""Provide test-suite.x86decomp_testkit.adapters.download functionality for the x86decomp-toolkit 0.7.9 release.
...
USER_AGENT = "x86decomp-test-suite/0.7.9"


def platform_key() -> str:
    """Implement platform key.
...
def github_latest_release(repository: str, timeout: int = 30) -> dict[str, Any]:
    """Implement github latest release.
...
def safe_extract_archive(archive: Path, destination: Path, max_members: int = 200_000) -> None:
    """Implement safe extract archive.
