"""Provide test-suite.x86decomp_testkit.live_adapters functionality for the x86decomp-toolkit 0.7.9 release.
...
from .models import AdapterSpec, ProbeResult, Status, TestResult
...
def _generic_executable_test(
    ...
    """Implement generic executable test.
