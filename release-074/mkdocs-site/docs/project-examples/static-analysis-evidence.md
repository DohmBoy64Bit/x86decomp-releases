...
| --- | --- | --- | --- |
| parser | `src/x86decomp/cli.py` | L108–L111 | `21e0654ced2f` |
| parser | `src/x86decomp/cli.py` | L198–L201 | `21e0654ced2f` |
| implementation | `ghidra_scripts/ExportFunctionArtifacts.java` | L162–L165 | `2c1a21482d49` |
| implementation | `src/x86decomp/analysis_db.py` | L185–L188 | `409e503d6c26` |
| implementation | `src/x86decomp/artifacts.py` | L45–L48 | `171833c573e1` |
| implementation | `src/x86decomp/evidence.py` | L199–L202 | `de8befd97c8e` |
| implementation | `src/x86decomp/pe.py` | L278–L281 | `39a5dd1b26da` |
| test | `tests/test_artifacts.py` | L31–L34 | `bcf7a774d955` |
| test | `tests/test_evidence.py` | L11–L14 | `4e8b73d7ad07` |
| doc | `docs/supported-scope.md` | L1–L4 | `c0e6743ef1b7` |
