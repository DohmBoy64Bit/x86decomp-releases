...
| --- | --- | --- | --- |
| parser | `src/x86decomp/cli.py` | L145–L148 | `21e0654ced2f` |
| parser | `src/x86decomp/cli.py` | L226–L229 | `21e0654ced2f` |
| implementation | `src/x86decomp/abi.py` | L153–L156 | `e69b8d4ba247` |
| implementation | `src/x86decomp/analysis_db.py` | L39–L42 | `409e503d6c26` |
| implementation | `src/x86decomp/analysis_db.py` | L70–L73 | `409e503d6c26` |
| implementation | `src/x86decomp/cpp_recovery.py` | L55–L58 | `c1f07b15f864` |
| test | `tests/test_abi_disassembly.py` | L9–L12 | `7707cba729a7` |
| test | `tests/test_modes_and_db.py` | L24–L27 | `7b3e58d0cbef` |
