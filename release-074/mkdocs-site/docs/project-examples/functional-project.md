...
| --- | --- | --- | --- |
| parser | `src/x86decomp/cli.py` | L146–L149 | `21e0654ced2f` |
| parser | `src/x86decomp/cli.py` | L152–L155 | `21e0654ced2f` |
| implementation | `src/x86decomp/dynamic.py` | L280–L283 | `a09cbba16f49` |
| implementation | `src/x86decomp/dynamic.py` | L327–L330 | `a09cbba16f49` |
| implementation | `src/x86decomp/harness_generator.py` | L21–L24 | `75ab6f14bcef` |
| implementation | `src/x86decomp/integration.py` | L273–L276 | `cb8157c82105` |
| implementation | `src/x86decomp/symbolic.py` | L605–L608 | `93d98f6e85a0` |
| implementation | `src/x86decomp/symbolic.py` | L683–L686 | `93d98f6e85a0` |
| test | `tests/test_dynamic_symbolic.py` | L14–L17 | `0b21be2ee69b` |
| test | `tests/test_integration.py` | L68–L71 | `0175ece91623` |
| test | `tests/test_production.py` | L209–L212 | `da0d4bd57f7f` |
