...
| --- | --- | --- | --- |
| parser | `src/x86decomp/cli.py` | L115–L118 | `21e0654ced2f` |
| parser | `src/x86decomp/cli.py` | L117–L120 | `21e0654ced2f` |
| implementation | `src/x86decomp/compiler.py` | L101–L104 | `f21f38f6ed08` |
| implementation | `src/x86decomp/compiler_lab.py` | L28–L31 | `05a54baba63c` |
| implementation | `src/x86decomp/compiler_lab.py` | L57–L60 | `05a54baba63c` |
| implementation | `src/x86decomp/compiler_lab.py` | L77–L80 | `05a54baba63c` |
| implementation | `src/x86decomp/toolchains.py` | L12–L15 | `9dde5962b67d` |
| test | `tests/test_compiler.py` | L13–L16 | `9645daed6877` |
| test | `tests/test_production.py` | L166–L169 | `da0d4bd57f7f` |
