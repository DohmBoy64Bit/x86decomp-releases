---
title: x86decomp memory-verify
description: The v0.7.4 parser declares this command without additional descriptive
  help text.
original_path: commands/memory-verify.html
---

<a id="command-memory-verify"></a>
...
```
x86decomp memory-verify [-h] project
```

### Syntax example

```
x86decomp memory-verify ./work
```
