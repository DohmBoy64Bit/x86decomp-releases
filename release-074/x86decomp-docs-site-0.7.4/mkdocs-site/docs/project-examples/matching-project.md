...
| --- | --- | --- | --- |
| parser | `src/x86decomp/cli.py` | L122–L125 | `21e0654ced2f` |
| parser | `src/x86decomp/cli.py` | L132–L135 | `21e0654ced2f` |
| implementation | `src/x86decomp/coff.py` | L875–L878 | `f6900af73b99` |
| implementation | `src/x86decomp/exe_diff.py` | L84–L87 | `997ffacbd833` |
| implementation | `src/x86decomp/image_match.py` | L186–L189 | `a9c72f376532` |
| implementation | `src/x86decomp/workflow.py` | L34–L37 | `cae8a093f08f` |
| test | `tests/test_coff.py` | L9–L12 | `57797f4ad3e7` |
| test | `tests/test_linker_metadata_corpus.py` | L109–L112 | `aa88771eecf6` |
| test | `tests/test_modes_and_db.py` | L12–L15 | `7b3e58d0cbef` |
