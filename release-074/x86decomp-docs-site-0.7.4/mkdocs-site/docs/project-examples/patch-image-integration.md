...
| --- | --- | --- | --- |
| parser | `src/x86decomp/cli.py` | L154–L157 | `21e0654ced2f` |
| implementation | `src/x86decomp/patching.py` | L39–L42 | `61b9d802fc2c` |
| implementation | `src/x86decomp/patching.py` | L65–L68 | `61b9d802fc2c` |
| implementation | `src/x86decomp/pe.py` | L278–L281 | `39a5dd1b26da` |
| test | `tests/test_pe64_patch_hybrid.py` | L22–L25 | `6894dd0e5abc` |
| test | `tests/test_pe64_patch_hybrid.py` | L27–L30 | `6894dd0e5abc` |
