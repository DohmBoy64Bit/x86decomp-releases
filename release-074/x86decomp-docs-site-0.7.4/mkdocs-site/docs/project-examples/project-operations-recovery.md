...
| --- | --- | --- | --- |
| parser | `src/x86decomp/cli.py` | L210–L213 | `21e0654ced2f` |
| parser | `src/x86decomp/cli.py` | L220–L223 | `21e0654ced2f` |
| implementation | `src/x86decomp/content_store.py` | L45–L48 | `4902a167d8d4` |
| implementation | `src/x86decomp/orchestrator.py` | L187–L190 | `752a6e6b5d4f` |
| implementation | `src/x86decomp/project.py` | L103–L106 | `a9077107216c` |
| implementation | `src/x86decomp/project_state.py` | L186–L189 | `8d063061a36e` |
| implementation | `src/x86decomp/project_state.py` | L243–L246 | `8d063061a36e` |
| test | `tests/test_production.py` | L94–L97 | `da0d4bd57f7f` |
| test | `tests/test_production.py` | L122–L125 | `da0d4bd57f7f` |
