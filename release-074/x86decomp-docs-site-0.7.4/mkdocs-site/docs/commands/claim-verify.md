---
title: x86decomp claim-verify
description: The v0.7.4 parser declares this command without additional descriptive
  help text.
original_path: commands/claim-verify.html
---

<a id="command-claim-verify"></a>
...
```
x86decomp claim-verify [-h] project claim_id
```

### Syntax example

```
x86decomp claim-verify ./work example-001
```
...
| `claim_id` required | No argument help text is declared; parser destination is `claim_id`. |
