---
title: x86decomp project-backup
description: The v0.7.4 parser declares this command without additional descriptive
  help text.
original_path: commands/project-backup.html
---

<a id="command-project-backup"></a>
...
```
x86decomp project-backup [-h] project output
```

### Syntax example

```
x86decomp project-backup ./work ./output.json
```
