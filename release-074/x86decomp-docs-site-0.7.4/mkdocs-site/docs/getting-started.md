...
These commands were parsed against the actual 0.7.4 toolkit and verification-harness parsers.

## <span class="doc-step-number">1</span> Install the packaged wheels { .doc-step }

```
python -m pip install .\x86decomp_toolkit-0.7.4-py3-none-any.whl
python -m pip install .\x86decomp_test_suite-0.7.4-py3-none-any.whl
```
