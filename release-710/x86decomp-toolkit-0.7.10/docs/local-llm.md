...
## 0.7.10 decompilation acceleration loop

0.7.10 adds the missing job materialization and queue-management layer around the existing local-model proposal loop:
...
## 0.7.10 harness capability mapping
