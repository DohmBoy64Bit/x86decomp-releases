...
description: Evidence-first operation of the unified x86decomp-toolkit 0.7.10 release.
version: 7.5.0
license: Apache-2.0
compatibility: Python 3.11+, x86decomp-toolkit 0.7.10, native PE32/i386 and PE32+/AMD64, optional bounded validation adapters
metadata:
  release_contract: 0.7.10
