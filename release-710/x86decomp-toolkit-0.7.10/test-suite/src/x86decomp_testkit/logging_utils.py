...
class JsonlEventLogger:
    """Coordinate jsonl event logger behavior for the current toolkit workflow."""
    ...
    def emit(self, event: str, **fields: Any) -> None:
        """Execute the emit operation for the current toolkit workflow."""
...
def configure_logging(output_directory: Path, verbose: bool = False) -> tuple[logging.Logger, JsonlEventLogger]:
    """Execute the configure logging operation for the current toolkit workflow."""
