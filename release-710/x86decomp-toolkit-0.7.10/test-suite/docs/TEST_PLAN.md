# Comprehensive test plan — 0.7.10

## Exact current inventory

The feature catalog pins 116 Python modules, 945 function and method bodies, 166 root commands, 59 canonical groups, 239 canonical routes, 97 schemas, 3 Ghidra scripts, and 37 adapter contracts.
...
The current adapter catalog contains 37 adapters, including the v0.7.10 `lm-studio-http` endpoint adapter.
