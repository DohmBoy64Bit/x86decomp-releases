"""Provide test-suite.tests.test_architecture_maps functionality for the x86decomp-toolkit 0.7.10 release.

This module-level documentation was added during the complete 0.7.10 code audit.
"""
...
def test_all_architecture_map_artifacts_exist_and_are_versioned() -> None:
    ...
    for relative in REQUIRED_MAPS:
        ...
        assert "0.7.10" in text, f"architecture version missing from {relative}"
