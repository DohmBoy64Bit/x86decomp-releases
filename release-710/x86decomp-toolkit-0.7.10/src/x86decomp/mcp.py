...
class MCPTool:
    """Store validated m c p tool fields used by toolkit reports and adapters."""
    name: str
...
class StdioMCPClient:
    """Coordinate stdio m c p client behavior for the current toolkit workflow."""
    ...
    def _send(self, message: dict[str, Any]) -> None:
        """Support send processing for internal toolkit callers."""
    ...
    def _request(self, method: str, params: dict[str, Any] | None = None) -> dict[str, Any]:
        """Support request processing for internal toolkit callers."""
    ...
    def _ensure_initialized(self) -> None:
        """Support ensure initialized processing for internal toolkit callers."""
        if not self.initialized:
            self.initialize()

    def list_tools(self) -> list[MCPTool]:
        """Execute the list tools operation for the current toolkit workflow."""
    ...
    def call_tool(self, name: str, arguments: dict[str, Any]) -> dict[str, Any]:
        """Execute the call tool operation for the current toolkit workflow."""
        self._ensure_initialized()
...
class StreamableHTTPMCPClient:
    """Coordinate streamable h t t p m c p client behavior for the current toolkit workflow."""
    ...
    def _notify(self, method: str) -> None:
        """Support notify processing for internal toolkit callers."""
...
def is_probable_mutation(tool_name: str) -> bool:
    """Execute the is probable mutation operation for the current toolkit workflow."""
...
class GhidraMCPGateway:
    ...
    def propose_mutation(
        ...
        *,
        ...
        """Execute the propose mutation operation for the current toolkit workflow."""
    ...
    def commit_mutation(self, approval_hash: str) -> dict[str, Any]:
        """Execute the commit mutation operation for the current toolkit workflow."""
