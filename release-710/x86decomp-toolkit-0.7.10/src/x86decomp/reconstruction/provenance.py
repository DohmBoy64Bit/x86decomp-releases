"""Provide the current runtime implementation for the `x86decomp.reconstruction.provenance` module."""
...
class ProvenanceLedger:
    """Coordinate provenance ledger behavior for the current toolkit workflow."""
    ...
    def source(self,path:str,line:int|None=None)->list[dict[str,Any]]:
        """Execute the source operation for the current toolkit workflow."""
    ...
    def binary(self,binary_id:str,address:str|None=None)->list[dict[str,Any]]:
        """Execute the binary operation for the current toolkit workflow."""
        with self.store.connect() as c:
    ...
    def unlock(self,path:str,*,actor:str='analyst')->dict[str,Any]:
        """Execute the unlock operation for the current toolkit workflow."""
        path=ensure_relative_path(path).as_posix()
        with self.store.transaction() as c:
    ...
    def reconcile(self,path:str,*,before_sha256:str|None=None,semantic:bool|None=None,actor:str='analyst')->dict[str,Any]:
        """Execute the reconcile operation for the current toolkit workflow."""
