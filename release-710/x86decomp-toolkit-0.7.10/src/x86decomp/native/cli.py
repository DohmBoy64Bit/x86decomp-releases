"""Provide the current runtime implementation for the `x86decomp.native.cli` module."""
...
def build_parser(*, prog: str = "x86decomp-native") -> argparse.ArgumentParser:
    ...
    parser=argparse.ArgumentParser(prog=prog,description='x86decomp-toolkit 0.7.10 native PE reconstruction and closed-loop matching')
...
def main(argv:list[str]|None=None)->int:
    ...
    try:
        args=build_parser().parse_args(argv); emit_json(dispatch(args)); return 0
