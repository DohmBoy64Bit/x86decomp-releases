"""Provide the current runtime implementation for the `x86decomp.native.runtime` module."""
...
class RuntimeValidation:
    """Coordinate runtime validation behavior for the current toolkit workflow."""
    ...
    def validate_image(self,image_path:Path, *, actor:str='analyst')->dict[str,Any]:
        """Validate image for the current toolkit workflow."""
    ...
    def launch(self,image_path:Path, *, execute:bool=False, timeout_seconds:int=10, arguments:list[str]|None=None, actor:str='analyst')->dict[str,Any]:
        """Execute the launch operation for the current toolkit workflow."""
    ...
    def map_crash(self,rva:int)->dict[str,Any]:
        """Execute the map crash operation for the current toolkit workflow."""
    ...
    def _record(self,path:Path,kind:str,checks:dict[str,Any],details:dict[str,Any],authorized:bool,actor:str)->dict[str,Any]:
        """Support record processing for internal toolkit callers."""
