"""Provide the current runtime implementation for the `x86decomp.governance.campaigns` module."""
...
class CampaignEngine:
    ...
    def _validate_budget(value: dict[str, Any]) -> dict[str, int]:
        """Support validate budget processing for internal toolkit callers."""
    ...
    def transition(self, campaign_id: str, new_state: str, *, reason: str | None = None, actor: str = "analyst") -> dict[str, Any]:
        """Execute the transition operation for the current toolkit workflow."""
    ...
    def consume_budget(self, campaign_id: str, dimension: str, amount: int, *, actor: str = "system") -> dict[str, Any]:
        """Execute the consume budget operation for the current toolkit workflow."""
        if amount < 0:
    ...
    def branch(self, campaign_id: str, name: str, *, parent_branch_id: str | None = None, actor: str = "analyst") -> dict[str, Any]:
        """Execute the branch operation for the current toolkit workflow."""
    ...
    def get_branch(self, branch_id: str) -> dict[str, Any]:
        """Execute the get branch operation for the current toolkit workflow."""
    ...
    def _decision(row: Any) -> dict[str, Any]:
        """Support decision processing for internal toolkit callers."""
        result = dict(row)
        result["rationale"] = json.loads(result.pop("rationale_json"))
        return result

    def plan_next(self, campaign_id: str, *, actor: str = "planner") -> dict[str, Any]:
        """Execute the plan next operation for the current toolkit workflow."""
        campaign = self.get(campaign_id)
